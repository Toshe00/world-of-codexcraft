...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.naturePlacementLab.title': 'Laboratoire de placement naturel',
  'hudChrome.naturePlacementLab.assetsSection': 'Ressources',
  'hudChrome.naturePlacementLab.projectsSection': 'Projets',
  'hudChrome.naturePlacementLab.layersSection': 'Calques',
  'hudChrome.naturePlacementLab.groupsSection': 'Groupes',
  'hudChrome.naturePlacementLab.statisticsSection': 'Statistiques',
  'hudChrome.naturePlacementLab.selectionSection': 'Sélection',
  'hudChrome.naturePlacementLab.transformSection': 'Transformation',
  ...
  'hudChrome.naturePlacementLab.saveProjectAs': 'Enregistrer le projet sous',
  'hudChrome.naturePlacementLab.loadProject': 'Charger le projet',
  'hudChrome.naturePlacementLab.deleteProject': 'Supprimer le projet',
  'hudChrome.naturePlacementLab.projectNamePrompt': 'Nom du projet',
  'hudChrome.naturePlacementLab.confirmDeleteProject': 'Supprimer le projet local actif ?',
  'hudChrome.naturePlacementLab.untitledProjectName': 'Projet sans titre',
  'hudChrome.naturePlacementLab.importedProjectName': 'Placements importés',
  'hudChrome.naturePlacementLab.createLayer': 'Créer un calque',
  'hudChrome.naturePlacementLab.renameLayer': 'Renommer le calque',
  'hudChrome.naturePlacementLab.deleteLayer': 'Supprimer le calque',
  'hudChrome.naturePlacementLab.deleteLayerPlacements': 'Supprimer les objets du calque',
  'hudChrome.naturePlacementLab.layerNamePrompt': 'Nom du calque',
  'hudChrome.naturePlacementLab.defaultLayerTrees': 'Arbres',
  'hudChrome.naturePlacementLab.defaultLayerBushes': 'Buissons',
  'hudChrome.naturePlacementLab.defaultLayerFlowers': 'Fleurs',
  'hudChrome.naturePlacementLab.defaultLayerGrass': 'Herbe',
  'hudChrome.naturePlacementLab.defaultLayerDeadNature': 'Nature morte',
  'hudChrome.naturePlacementLab.defaultLayerOther': 'Autres',
  'hudChrome.naturePlacementLab.confirmDeleteLayer': 'Supprimer ce calque vide ?',
  'hudChrome.naturePlacementLab.confirmDeleteLayerPlacements':
    'Supprimer tous les objets non verrouillés de ce calque ?',
  'hudChrome.naturePlacementLab.visible': 'Visible',
  'hudChrome.naturePlacementLab.locked': 'Verrouillé',
  'hudChrome.naturePlacementLab.selectLayer': 'Sélectionner le calque',
  'hudChrome.naturePlacementLab.selectAll': 'Tout sélectionner',
  'hudChrome.naturePlacementLab.deselectAll': 'Tout désélectionner',
  'hudChrome.naturePlacementLab.invertSelection': 'Inverser la sélection',
  'hudChrome.naturePlacementLab.selectByAsset': 'Sélectionner par ressource',
  'hudChrome.naturePlacementLab.moveToLayer': 'Déplacer vers le calque',
  'hudChrome.naturePlacementLab.selectedCount': 'Objets sélectionnés : {count}',
  'hudChrome.naturePlacementLab.selectedAssets': 'Ressources sélectionnées : {assets}',
  'hudChrome.naturePlacementLab.selectedLayers': 'Calques sélectionnés : {layers}',
  'hudChrome.naturePlacementLab.groupSelection': 'Grouper la sélection',
  'hudChrome.naturePlacementLab.ungroup': 'Dégrouper',
  'hudChrome.naturePlacementLab.renameGroup': 'Renommer le groupe',
  'hudChrome.naturePlacementLab.selectGroup': 'Sélectionner le groupe',
  'hudChrome.naturePlacementLab.duplicateGroup': 'Dupliquer le groupe',
  'hudChrome.naturePlacementLab.deleteGroup': 'Supprimer le groupe',
  'hudChrome.naturePlacementLab.deleteGroupAndPlacements':
    'Supprimer le groupe et ses placements',
  'hudChrome.naturePlacementLab.groupNamePrompt': 'Nom du groupe',
  'hudChrome.naturePlacementLab.confirmDeleteGroupPlacements':
    'Supprimer ce groupe et tous ses objets non verrouillés ?',
  'hudChrome.naturePlacementLab.groupCopyName': 'Copie de {name}',
  'hudChrome.naturePlacementLab.groupSummary': '{name} ({count})',
  'hudChrome.naturePlacementLab.applyGroupTransform':
    'Appliquer la transformation au groupe',
  'hudChrome.naturePlacementLab.selectionCenterX': 'Centre de la sélection en X',
  'hudChrome.naturePlacementLab.selectionCenterY': 'Centre de la sélection en Y',
  'hudChrome.naturePlacementLab.selectionCenterZ': 'Centre de la sélection en Z',
  'hudChrome.naturePlacementLab.rotationDelta': 'Delta de rotation (degrés)',
  'hudChrome.naturePlacementLab.scaleFactor': "Facteur d'échelle relatif",
  'hudChrome.naturePlacementLab.groundOffsetDelta': 'Delta de décalage au sol',
  'hudChrome.naturePlacementLab.totalPlacements': 'Placements au total : {count}',
  'hudChrome.naturePlacementLab.visiblePlacements': 'Placements visibles : {count}',
  'hudChrome.naturePlacementLab.statisticsSelected': 'Placements sélectionnés : {count}',
  'hudChrome.naturePlacementLab.placementsByAsset': 'Par ressource : {counts}',
  'hudChrome.naturePlacementLab.placementsByLayer': 'Par calque : {counts}',
  'hudChrome.naturePlacementLab.estimatedTriangles': 'Triangles estimés : {count}',
  'hudChrome.naturePlacementLab.estimatedMediaBytes':
    'Médias des ressources uniques : {count} octets',
  'hudChrome.naturePlacementLab.assetsAria': 'Ressources du laboratoire',
  'hudChrome.naturePlacementLab.placeSelected': 'Placer la ressource sélectionnée',
  'hudChrome.naturePlacementLab.deleteSelected': 'Supprimer la sélection',
  ...
  'hudChrome.naturePlacementLab.duplicate': 'Dupliquer',
  'hudChrome.naturePlacementLab.id': 'ID',
  'hudChrome.naturePlacementLab.assetId': 'ID de ressource',
  'hudChrome.naturePlacementLab.positionX': 'Position X',
  'hudChrome.naturePlacementLab.positionY': 'Position Y',
  'hudChrome.naturePlacementLab.positionZ': 'Position Z',
  'hudChrome.naturePlacementLab.rotationYDegrees': 'Rotation Y (degrés)',
  'hudChrome.naturePlacementLab.scale': 'Échelle',
  'hudChrome.naturePlacementLab.groundOffsetY': 'Décalage au sol en Y',
  'hudChrome.naturePlacementLab.showGrid': 'Afficher la grille',
  'hudChrome.naturePlacementLab.hideGrid': 'Masquer la grille',
  'hudChrome.naturePlacementLab.gridSize': 'Taille des cellules de la grille',
  'hudChrome.naturePlacementLab.snapPosition': 'Magnétisme de position',
  'hudChrome.naturePlacementLab.snapRotation': 'Magnétisme de rotation',
  'hudChrome.naturePlacementLab.snapScale': "Magnétisme d'échelle",
  'hudChrome.naturePlacementLab.snapToGround': 'Aligner sur le sol',
  'hudChrome.naturePlacementLab.rotationStep': 'Pas de rotation (degrés)',
  'hudChrome.naturePlacementLab.scaleStep': "Pas d'échelle",
  'hudChrome.naturePlacementLab.undo': 'Annuler',
  'hudChrome.naturePlacementLab.redo': 'Rétablir',
  'hudChrome.naturePlacementLab.available': 'disponible',
  'hudChrome.naturePlacementLab.unavailable': 'indisponible',
  'hudChrome.naturePlacementLab.historyState': 'Annuler : {undo}. Rétablir : {redo}.',
  'hudChrome.naturePlacementLab.selectedObject': 'Objet sélectionné : {id}',
  'hudChrome.naturePlacementLab.selectedAsset': 'Ressource sélectionnée : {assetId}',
  'hudChrome.naturePlacementLab.noAssetSelected': 'Aucune ressource sélectionnée',
  'hudChrome.naturePlacementLab.cancelPlacement': 'Annuler le placement',
  'hudChrome.naturePlacementLab.placementsCount': 'Placements du laboratoire : {count}',
  'hudChrome.naturePlacementLab.help':
    'Ctrl+Z/Y annule et rétablit. Ctrl+D duplique. G affiche ou masque la grille. X active ou désactive le magnétisme de position. T place au sol. R fait pivoter. La molette ou les touches plus et moins modifient l’échelle. Page précédente et Page suivante ajustent la hauteur.',
  'hudChrome.naturePlacementLab.statusReady': 'Prêt',
  'hudChrome.naturePlacementLab.statusAssetSelected': '{assetId} sélectionné',
  'hudChrome.naturePlacementLab.statusSelectAssetFirst': "Sélectionnez d'abord une ressource",
  'hudChrome.naturePlacementLab.statusPlacementActive': 'Mode placement actif',
  ...
  'hudChrome.naturePlacementLab.statusPlacementDeleted': 'Placement supprimé',
  'hudChrome.naturePlacementLab.statusCleared': 'Tous les placements du laboratoire sont effacés',
  'hudChrome.naturePlacementLab.statusExported': '{count} placements exportés',
  'hudChrome.naturePlacementLab.statusImported': '{count} placements importés',
  'hudChrome.naturePlacementLab.statusImportFailed': "Échec de l'importation des placements",
  'hudChrome.naturePlacementLab.statusTransformAdjusted': 'Transformation ajustée',
  'hudChrome.naturePlacementLab.statusNothingToUndo': 'Aucune modification à annuler',
  'hudChrome.naturePlacementLab.statusNothingToRedo': 'Aucune modification à rétablir',
  'hudChrome.naturePlacementLab.statusUndone': 'Dernière modification annulée',
  'hudChrome.naturePlacementLab.statusRedone': 'Dernière modification rétablie',
  'hudChrome.naturePlacementLab.statusDuplicateFailed':
    'Impossible de dupliquer le placement sélectionné',
  'hudChrome.naturePlacementLab.statusDuplicated': '{id} dupliqué et sélectionné',
  'hudChrome.naturePlacementLab.statusTransformRejected': 'Transformation refusée',
  'hudChrome.naturePlacementLab.statusTransformApplied': 'Transformation appliquée',
  'hudChrome.naturePlacementLab.statusTransformReset':
    'Transformation réinitialisée aux valeurs par défaut de la ressource',
  'hudChrome.naturePlacementLab.statusPlacedOnGround':
    'Placement aligné sur le terrain existant',
  'hudChrome.naturePlacementLab.statusPreferencesSaved': "Options de l'éditeur mises à jour",
  'hudChrome.naturePlacementLab.statusFiniteRequired': '{field} doit être un nombre fini',
  ...
  'hudChrome.naturePlacementLab.statusLockedLayer':
    'Un calque verrouillé empêche cette opération',
  'hudChrome.naturePlacementLab.statusOperationRejected': "L'opération a été refusée",
  'hudChrome.naturePlacementLab.statusProjectCreated': 'Projet créé',
  'hudChrome.naturePlacementLab.statusProjectRenamed': 'Projet renommé',
  'hudChrome.naturePlacementLab.statusProjectSaved': 'Projet enregistré localement',
  'hudChrome.naturePlacementLab.statusProjectLoaded': 'Projet chargé',
  'hudChrome.naturePlacementLab.statusProjectDeleted': 'Projet supprimé',
  'hudChrome.naturePlacementLab.statusProjectFailed': "Échec de l'opération sur le projet",
  'hudChrome.naturePlacementLab.statusLayerCreated': 'Calque créé',
  'hudChrome.naturePlacementLab.statusLayerRenamed': 'Calque renommé',
  'hudChrome.naturePlacementLab.statusLayerDeleted': 'Calque supprimé',
  'hudChrome.naturePlacementLab.statusLayerCleared': 'Objets du calque supprimés',
  'hudChrome.naturePlacementLab.statusLayerUpdated': 'État du calque mis à jour',
  'hudChrome.naturePlacementLab.statusLayerChanged': 'Sélection déplacée vers le calque',
  'hudChrome.naturePlacementLab.statusGroupCreated': 'Groupe créé',
  ...
  'hudChrome.startZoneTerrainSurvey.title': 'Relevé du terrain de la zone de départ',
  'hudChrome.startZoneTerrainSurvey.terrainSection': 'Analyse du terrain',
  'hudChrome.startZoneTerrainSurvey.footprintSection': 'Empreinte du bâtiment',
  'hudChrome.startZoneTerrainSurvey.anchorSection': "Points d'ancrage",
  'hudChrome.startZoneTerrainSurvey.resolution': 'Résolution de la grille',
  'hudChrome.startZoneTerrainSurvey.selectedTemplate': 'Gabarit de bâtiment',
  'hudChrome.startZoneTerrainSurvey.rotation': 'Rotation Y',
  'hudChrome.startZoneTerrainSurvey.showGrid': 'Afficher la grille',
  'hudChrome.startZoneTerrainSurvey.hideGrid': 'Masquer la grille',
  'hudChrome.startZoneTerrainSurvey.smallHouse': 'Petite maison 6 x 6',
  'hudChrome.startZoneTerrainSurvey.mediumHouse': 'Maison moyenne 10 x 8',
  'hudChrome.startZoneTerrainSurvey.largeHouse': 'Grande maison 14 x 12',
  'hudChrome.startZoneTerrainSurvey.centralPlaza': 'Place centrale 20 x 20',
  'hudChrome.startZoneTerrainSurvey.road': 'Route 4 x 12',
  'hudChrome.startZoneTerrainSurvey.minimumHeight': 'Hauteur minimale : {value} m',
  'hudChrome.startZoneTerrainSurvey.maximumHeight': 'Hauteur maximale : {value} m',
  'hudChrome.startZoneTerrainSurvey.averageSlope': 'Pente moyenne : {value} degrés',
  'hudChrome.startZoneTerrainSurvey.maximumSlope': 'Pente maximale : {value} degrés',
  'hudChrome.startZoneTerrainSurvey.flatSurface': 'Terrain plat : {value} %',
  'hudChrome.startZoneTerrainSurvey.compatibleSurfaces': 'Surfaces compatibles : {count}',
  'hudChrome.startZoneTerrainSurvey.anchorsCount': 'Ancrages enregistrés : {count}',
  'hudChrome.startZoneTerrainSurvey.verdict': 'Verdict sous le curseur : {verdict}',
  'hudChrome.startZoneTerrainSurvey.compatible': 'compatible',
  'hudChrome.startZoneTerrainSurvey.incompatible': 'incompatible',
  'hudChrome.startZoneTerrainSurvey.noTerrain': 'hors du terrain analysé',
  'hudChrome.startZoneTerrainSurvey.cornerDifference': '{corner} : {value} m',
  'hudChrome.startZoneTerrainSurvey.anchorName': "Nom de l'ancrage",
  'hudChrome.startZoneTerrainSurvey.anchorNameDefault': 'Ancrage du relevé',
  'hudChrome.startZoneTerrainSurvey.proposedType': 'Type proposé',
  'hudChrome.startZoneTerrainSurvey.notes': 'Notes',
  'hudChrome.startZoneTerrainSurvey.saveAnchor': "Enregistrer le point d'ancrage",
  'hudChrome.startZoneTerrainSurvey.clearAnchors': "Effacer les points d'ancrage",
  'hudChrome.startZoneTerrainSurvey.exportReport': 'Exporter le rapport JSON',
  'hudChrome.startZoneTerrainSurvey.typeBuildingSmall': 'Petit bâtiment',
  'hudChrome.startZoneTerrainSurvey.typeBuildingMedium': 'Bâtiment moyen',
  'hudChrome.startZoneTerrainSurvey.typeBuildingLarge': 'Grand bâtiment',
  'hudChrome.startZoneTerrainSurvey.typePlaza': 'Place',
  'hudChrome.startZoneTerrainSurvey.typeRoad': 'Route',
  'hudChrome.startZoneTerrainSurvey.typeDecorative': 'Décoratif',
  'hudChrome.startZoneTerrainSurvey.typeAvoid': 'À éviter',
  'hudChrome.startZoneTerrainSurvey.statusAnchorSaved': 'Point d’ancrage enregistré localement',
  'hudChrome.startZoneTerrainSurvey.statusAnchorRejected':
    "Le point d'ancrage n'a pas pu être enregistré",
  'hudChrome.startZoneTerrainSurvey.statusAnchorsCleared':
    "Points d'ancrage locaux effacés",
  'hudChrome.startZoneTerrainPlateau.title': 'Laboratoire de plateau de la zone de départ',
  'hudChrome.startZoneTerrainPlateau.enabled': 'Afficher le plateau',
  'hudChrome.startZoneTerrainPlateau.centerX': 'Centre X',
  'hudChrome.startZoneTerrainPlateau.centerZ': 'Centre Z',
  'hudChrome.startZoneTerrainPlateau.width': 'Largeur',
  'hudChrome.startZoneTerrainPlateau.depth': 'Profondeur',
  'hudChrome.startZoneTerrainPlateau.rotation': 'Rotation Y',
  'hudChrome.startZoneTerrainPlateau.targetHeight': 'Hauteur cible',
  'hudChrome.startZoneTerrainPlateau.blendWidth': 'Largeur de transition',
  'hudChrome.startZoneTerrainPlateau.falloff': 'Courbe de transition',
  'hudChrome.startZoneTerrainPlateau.linear': 'Linéaire',
  'hudChrome.startZoneTerrainPlateau.smoothstep': 'Smoothstep',
  'hudChrome.startZoneTerrainPlateau.smootherstep': 'Smootherstep',
  'hudChrome.startZoneTerrainPlateau.averageHeight': 'Utiliser la hauteur moyenne',
  'hudChrome.startZoneTerrainPlateau.cursorHeight': 'Utiliser la hauteur du curseur',
  'hudChrome.startZoneTerrainPlateau.undo': 'Annuler',
  'hudChrome.startZoneTerrainPlateau.redo': 'Rétablir',
  'hudChrome.startZoneTerrainPlateau.reset': 'Réinitialiser',
  'hudChrome.startZoneTerrainPlateau.export': 'Exporter le JSON',
  'hudChrome.startZoneTerrainPlateau.import': 'Importer le JSON',
  'hudChrome.startZoneTerrainPlateau.importPlaceholder': 'Collez un document JSON de plateau',
  'hudChrome.startZoneTerrainPlateau.target': 'Hauteur cible : {value} m',
  'hudChrome.startZoneTerrainPlateau.minimum': 'Minimum original : {value} m',
  'hudChrome.startZoneTerrainPlateau.maximum': 'Maximum original : {value} m',
  'hudChrome.startZoneTerrainPlateau.raised': 'Terrain relevé maximal : {value} m',
  'hudChrome.startZoneTerrainPlateau.lowered': 'Terrain abaissé maximal : {value} m',
  'hudChrome.startZoneTerrainPlateau.flatArea': 'Surface parfaitement plane : {value} m²',
  'hudChrome.startZoneTerrainPlateau.transitionArea': 'Surface de transition : {value} m²',
  'hudChrome.startZoneTerrainPlateau.protectedWarning': 'Zones protégées rencontrées : {count}',
  'hudChrome.startZoneTerrainPlateau.showProtectedZones': 'Afficher les zones protégées',
  'hudChrome.startZoneTerrainPlateau.protectedZonesHelp': 'Ces cercles indiquent les zones protégées autour des PNJ, marchands, points de quête et autres éléments importants.',
  ...
  'editor.docTitle': 'Éditeur de cartes - World of CodexCraft',
  ...
  'seo.officialLabel': 'Site officiel de World of CodexCraft',
  'seo.officialBody':
  ...
  'playerCard.defaultRealm': 'Monde de CodexCraft',
  ...
  'playerCard.shareText':
    'Je forge ma légende dans World of CodexCraft : niveau {level} {className}{tierBit}. Rejoignez mon monde :',
  'playerCard.nativeShareTitle': 'Monde de CodexCraft',
  ...
  'seo.description':
    'Partez pour une aventure épique dans World of CodexCraft, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un monde persistant, progressez en classe et terrassez vos ennemis.',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'Ouvrir le projet World of CodexCraft sur GitHub',
  'a11y.discordCommunity': 'Rejoindre la communauté World of CodexCraft sur Discord',
  'a11y.donateProject': 'Faire un don pour soutenir World of CodexCraft',
  ...
  'mobilePreflight.iosOpenStep':
    "Ouvrez World of CodexCraft depuis la nouvelle icône de l'écran d'accueil.",
  ...
  'mobilePreflight.androidOpenStep': 'Ouvrez World of CodexCraft depuis la nouvelle icône.',
  ...
  'serverUnavailable.title': 'World of CodexCraft - Monde indisponible',
  ...
  'mode.play': 'Jouer',
  'mode.playAria': 'Jouer à World of CodexCraft',
  ...
  'guide.worldPage.intro':
    "World of CodexCraft est une seule terre continue que l'on traverse à pied, trois zones disposées du sud au nord. Il n'y a pas de voyage rapide, alors le trajet fait partie de l'aventure.",
  ...
  'desktop.crash.fatalBody':
    'World of CodexCraft a rencontré une erreur inattendue et doit se fermer.',
  ...
  'hudChrome.nativeUpdate.body':
    'Une nouvelle version de World of CodexCraft est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'La version {version} de World of CodexCraft est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.',
