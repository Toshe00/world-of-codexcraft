...
export const shellStrings = {
  en: {
    seo: {
      ...
      description:
        'Embark on an epic adventure in World of CodexCraft, a classic-style micro-MMO playable directly in your browser. Join a persistent shared world, level up classes, and defeat enemies!',
      genre: 'MMORPG',
  ...
  es: {
    seo: {
      ...
      description:
        'Emprende una aventura épica en World of CodexCraft, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.',
      genre: 'MMORPG',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - Reino no disponible',
      logoAlt: 'World of CodexCraft',
  ...
  es_ES: {
    seo: {
      title: 'World of CodexCraft: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en World of CodexCraft, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.',
      genre: 'MMORPG',
      playMode: 'Multijugador',
      applicationCategory: 'Juego',
      operatingSystem: 'Navegador web',
  ...
  fr_FR: {
    seo: {
      ...
      description:
        'Partez pour une aventure épique dans World of CodexCraft, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
      genre: 'MMORPG',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - Royaume indisponible',
      logoAlt: 'World of CodexCraft',
  ...
  fr_CA: {
    seo: {
      title: 'World of CodexCraft: MMO Web de style classique',
      description:
        "Partez à l'aventure dans World of CodexCraft, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: 'MMORPG',
      playMode: 'Multijoueur',
      applicationCategory: 'Jeu',
      operatingSystem: 'Navigateur Web',
  ...
  en_CA: {
    seo: {
      title: 'World of CodexCraft: Classic-Style Web MMO',
      description:
        'Embark on an epic adventure in World of CodexCraft, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      playMode: 'Multiplayer',
      applicationCategory: 'Game',
      operatingSystem: 'Web browser',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - Realm Unavailable',
      logoAlt: 'World of CodexCraft',
  ...
  it_IT: {
    seo: {
      ...
      description:
        "Parti per un'avventura epica in World of CodexCraft, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: 'MMORPG',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - Reame non disponibile',
      logoAlt: 'World of CodexCraft',
  ...
  de_DE: {
    seo: {
      ...
      description:
        'Begib dich in World of CodexCraft auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
      genre: 'MMORPG',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - Realm nicht verfügbar',
      logoAlt: 'World of CodexCraft',
  ...
  zh_CN: {
    seo: {
      ...
      description:
        '在 World of CodexCraft 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
      genre: 'MMORPG',
      playMode: '多人游戏',
  ...
  zh_TW: {
    seo: {
      ...
      description:
        '在 World of CodexCraft 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
      genre: 'MMORPG',
      playMode: '多人遊戲',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - 伺服器不可用',
      logoAlt: 'World of CodexCraft',
      eyebrow: '伺服器維護',
      heading: '伺服器暫時不可用。',
  ...
  ko_KR: {
    seo: {
      ...
      description:
        '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, World of CodexCraft에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.',
      genre: 'MMORPG',
      playMode: '멀티플레이어',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - 렐름 이용 불가',
      logoAlt: 'World of CodexCraft',
      eyebrow: '렐름 점검',
  ...
  ja_JP: {
    seo: {
      ...
      description:
        'ブラウザで直接遊べるクラシック風マイクロMMO、World of CodexCraft で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。',
      genre: 'MMORPG',
      playMode: 'マルチプレイヤー',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - レルム利用不可',
      logoAlt: 'World of CodexCraft',
      eyebrow: 'レルムメンテナンス',
  ...
  pt_BR: {
    seo: {
      ...
      description:
        'Embarque em uma aventura épica em World of CodexCraft, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.',
      genre: 'MMORPG',
    ...
    serverUnavailable: {
      title: 'World of CodexCraft - Reino indisponível',
      logoAlt: 'World of CodexCraft',
  ...
  ru_RU: {
    seo: {
      ...
      description:
        'Отправьтесь в эпическое приключение в World of CodexCraft, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.',
      genre: 'MMORPG',
