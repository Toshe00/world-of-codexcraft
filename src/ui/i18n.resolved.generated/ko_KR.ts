...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    "naturePlacementLab": {
      ...
      "snappingSection": "스냅",
      "historySection": "기록",
      "importExportSection": "가져오기 및 내보내기",
      ...
      "projectNamePrompt": "프로젝트 이름",
      "confirmDeleteProject": "현재 로컬 프로젝트를 삭제하시겠습니까?",
      "untitledProjectName": "이름 없는 프로젝트",
      "importedProjectName": "가져온 배치",
      "createLayer": "레이어 만들기",
      "renameLayer": "레이어 이름 변경",
      "deleteLayer": "레이어 삭제",
      "deleteLayerPlacements": "레이어 배치 삭제",
      "layerNamePrompt": "레이어 이름",
      ...
      "confirmDeleteLayer": "이 빈 레이어를 삭제하시겠습니까?",
      "confirmDeleteLayerPlacements": "이 레이어의 모든 배치를 삭제하시겠습니까?",
      "visible": "표시",
      "locked": "잠김",
      "selectLayer": "레이어 선택",
      "selectAll": "모두 선택",
      ...
      "selectByAsset": "애셋별 선택",
      "moveToLayer": "레이어로 이동",
      "selectedCount": "선택됨: {count}",
      "selectedAssets": "애셋: {assets}",
      "selectedLayers": "레이어: {layers}",
      ...
      "deleteGroup": "그룹 삭제",
      "deleteGroupAndPlacements": "그룹과 배치 삭제",
      "groupNamePrompt": "그룹 이름",
      "confirmDeleteGroupPlacements": "이 그룹과 모든 배치를 삭제하시겠습니까?",
      "groupCopyName": "{name} 복사본",
      "groupSummary": "{name} ({count})",
      "applyGroupTransform": "그룹 변형 적용",
      "selectionCenterX": "선택 중심 X",
      "selectionCenterY": "선택 중심 Y",
      "selectionCenterZ": "선택 중심 Z",
      "rotationDelta": "회전 변화량",
      "scaleFactor": "크기 배율",
      "groundOffsetDelta": "지면 오프셋 변화량",
      "totalPlacements": "전체 배치: {count}",
      "visiblePlacements": "표시 배치: {count}",
      "statisticsSelected": "선택됨: {count}",
      "placementsByAsset": "애셋별: {counts}",
      "placementsByLayer": "레이어별: {counts}",
      "estimatedTriangles": "예상 삼각형: {count}",
      "estimatedMediaBytes": "예상 미디어 크기: {count}",
      "assetsAria": "실험실 애셋",
      ...
      "positionY": "위치 Y",
      "positionZ": "위치 Z",
      "rotationYDegrees": "Y 회전(도)",
      "scale": "크기",
      "groundOffsetY": "지면 Y 오프셋",
      "showGrid": "그리드 표시",
      "hideGrid": "그리드 숨기기",
      "gridSize": "그리드 셀 크기",
      "snapPosition": "위치 스냅",
      ...
      "snapScale": "크기 스냅",
      "snapToGround": "지면 스냅",
      "rotationStep": "회전 간격(도)",
      "scaleStep": "크기 간격",
      "undo": "실행 취소",
      "redo": "다시 실행",
      "available": "사용 가능",
      "unavailable": "사용 불가",
      "historyState": "실행 취소: {undo}. 다시 실행: {redo}.",
      ...
      "help": "Ctrl+Z/Y로 실행 취소 및 다시 실행. Ctrl+D로 복제. G로 그리드, X로 위치 스냅 전환. T로 지면에 배치. R로 회전. 휠 또는 더하기와 빼기로 크기 조절. Page Up과 Page Down으로 높이 조절.",
      "statusReady": "준비됨",
      ...
      "statusNothingToUndo": "실행 취소할 편집이 없습니다",
      "statusNothingToRedo": "다시 실행할 편집이 없습니다",
      "statusUndone": "마지막 편집을 취소했습니다",
      "statusRedone": "마지막 편집을 복원했습니다",
      "statusDuplicateFailed": "선택한 배치를 복제할 수 없습니다",
      "statusDuplicated": "{id} 복제 및 선택됨",
      "statusTransformRejected": "변형이 거부되었습니다",
      "statusTransformApplied": "변형 적용됨",
      "statusTransformReset": "변형을 애셋 기본값으로 초기화했습니다",
      "statusPlacedOnGround": "배치를 기존 지형에 맞췄습니다",
      "statusPreferencesSaved": "편집기 옵션이 업데이트되었습니다",
      "statusFiniteRequired": "{field}은(는) 유한한 숫자여야 합니다",
      "statusOutsideLimits": "{field}은(는) {min}에서 {max} 사이여야 합니다",
      "statusLockedLayer": "레이어가 잠겨 있습니다",
      "statusOperationRejected": "작업이 거부되었습니다",
      "statusProjectCreated": "프로젝트를 만들었습니다",
      "statusProjectRenamed": "프로젝트 이름을 변경했습니다",
      "statusProjectSaved": "프로젝트를 저장했습니다",
      "statusProjectLoaded": "프로젝트를 불러왔습니다",
      "statusProjectDeleted": "프로젝트를 삭제했습니다",
      "statusProjectFailed": "프로젝트 작업에 실패했습니다",
      "statusLayerCreated": "레이어를 만들었습니다",
      "statusLayerRenamed": "레이어 이름을 변경했습니다",
      "statusLayerDeleted": "레이어를 삭제했습니다",
      "statusLayerCleared": "레이어를 비웠습니다",
      "statusLayerUpdated": "레이어를 업데이트했습니다",
      "statusLayerChanged": "레이어를 변경했습니다",
      "statusGroupCreated": "그룹을 만들었습니다",
      "statusGroupRenamed": "그룹 이름을 변경했습니다",
      "statusGroupDuplicated": "그룹을 복제했습니다",
      "statusGroupDeleted": "그룹을 삭제했습니다"
    },
    "startZoneTerrainSurvey": {
      "title": "시작 지역 지형 조사",
      "terrainSection": "지형 분석",
      "footprintSection": "건물 설치 면적",
      "anchorSection": "앵커 지점",
      "resolution": "격자 해상도",
      "selectedTemplate": "건물 템플릿",
      "rotation": "Y축 회전",
      "showGrid": "격자 표시",
      "hideGrid": "격자 숨기기",
      "smallHouse": "소형 주택 6 x 6",
      "mediumHouse": "중형 주택 10 x 8",
      "largeHouse": "대형 주택 14 x 12",
      "centralPlaza": "중앙 광장 20 x 20",
      "road": "도로 4 x 12",
      "minimumHeight": "최저 높이: {value} m",
      "maximumHeight": "최고 높이: {value} m",
      "averageSlope": "평균 경사: {value}도",
      "maximumSlope": "최대 경사: {value}도",
      "flatSurface": "평탄한 지형: {value}%",
      "compatibleSurfaces": "적합 구역: {count}",
      "anchorsCount": "저장된 앵커: {count}",
      "verdict": "커서 위치 판정: {verdict}",
      "compatible": "적합",
      "incompatible": "부적합",
      "noTerrain": "조사된 지형 범위 밖",
      "cornerDifference": "{corner}: {value} m",
      "anchorName": "앵커 이름",
      "anchorNameDefault": "조사 앵커",
      "proposedType": "제안 유형",
      "notes": "메모",
      "saveAnchor": "앵커 지점 저장",
      "clearAnchors": "앵커 지점 지우기",
      "exportReport": "JSON 보고서 내보내기",
      "typeBuildingSmall": "소형 건물",
      "typeBuildingMedium": "중형 건물",
      "typeBuildingLarge": "대형 건물",
      "typePlaza": "광장",
      "typeRoad": "도로",
      "typeDecorative": "장식",
      "typeAvoid": "회피",
      "statusAnchorSaved": "앵커 지점을 로컬에 저장했습니다",
      "statusAnchorRejected": "앵커 지점을 저장할 수 없습니다",
      "statusAnchorsCleared": "로컬 앵커 지점을 지웠습니다"
    },
