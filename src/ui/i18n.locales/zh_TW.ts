...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  'hudChrome.naturePlacementLab.untitledProjectName': '未命名專案',
  'hudChrome.naturePlacementLab.importedProjectName': '匯入的配置專案',
  'hudChrome.naturePlacementLab.groupCopyName': '{name} 副本',
  'hudChrome.naturePlacementLab.groupSummary': '{name}（{count}）',
  'hudChrome.naturePlacementLab.projectsSection': '專案',
  'hudChrome.naturePlacementLab.layersSection': '圖層',
  'hudChrome.naturePlacementLab.groupsSection': '群組',
  'hudChrome.naturePlacementLab.statisticsSection': '統計',
  'hudChrome.naturePlacementLab.newProject': '新增專案',
  'hudChrome.naturePlacementLab.renameProject': '重新命名專案',
  'hudChrome.naturePlacementLab.saveProject': '儲存專案',
  'hudChrome.naturePlacementLab.saveProjectAs': '專案另存為',
  'hudChrome.naturePlacementLab.loadProject': '載入專案',
  'hudChrome.naturePlacementLab.deleteProject': '刪除專案',
  'hudChrome.naturePlacementLab.projectNamePrompt': '專案名稱',
  'hudChrome.naturePlacementLab.confirmDeleteProject': '刪除目前的本機專案？',
  'hudChrome.naturePlacementLab.createLayer': '建立圖層',
  'hudChrome.naturePlacementLab.renameLayer': '重新命名圖層',
  'hudChrome.naturePlacementLab.deleteLayer': '刪除圖層',
  'hudChrome.naturePlacementLab.deleteLayerPlacements': '刪除圖層物件',
  'hudChrome.naturePlacementLab.layerNamePrompt': '圖層名稱',
  'hudChrome.naturePlacementLab.confirmDeleteLayer': '刪除此空圖層？',
  'hudChrome.naturePlacementLab.confirmDeleteLayerPlacements': '刪除此圖層的所有物件？',
  'hudChrome.naturePlacementLab.visible': '可見',
  'hudChrome.naturePlacementLab.locked': '已鎖定',
  'hudChrome.naturePlacementLab.selectLayer': '選取圖層',
  'hudChrome.naturePlacementLab.selectAll': '全選',
  'hudChrome.naturePlacementLab.deselectAll': '取消全選',
  'hudChrome.naturePlacementLab.invertSelection': '反向選取',
  'hudChrome.naturePlacementLab.selectByAsset': '依資源選取',
  'hudChrome.naturePlacementLab.moveToLayer': '移至圖層',
  'hudChrome.naturePlacementLab.selectedCount': '已選取：{count}',
  'hudChrome.naturePlacementLab.selectedAssets': '資源：{assets}',
  'hudChrome.naturePlacementLab.selectedLayers': '圖層：{layers}',
  'hudChrome.naturePlacementLab.groupSelection': '群組選取項目',
  'hudChrome.naturePlacementLab.ungroup': '取消群組',
  'hudChrome.naturePlacementLab.renameGroup': '重新命名群組',
  'hudChrome.naturePlacementLab.selectGroup': '選取群組',
  'hudChrome.naturePlacementLab.duplicateGroup': '複製群組',
  'hudChrome.naturePlacementLab.deleteGroup': '刪除群組',
  'hudChrome.naturePlacementLab.deleteGroupAndPlacements': '刪除群組及物件',
  'hudChrome.naturePlacementLab.groupNamePrompt': '群組名稱',
  'hudChrome.naturePlacementLab.confirmDeleteGroupPlacements': '刪除此群組及其所有物件？',
  'hudChrome.naturePlacementLab.applyGroupTransform': '套用群組變換',
  'hudChrome.naturePlacementLab.selectionCenterX': '選取中心 X',
  'hudChrome.naturePlacementLab.selectionCenterY': '選取中心 Y',
  'hudChrome.naturePlacementLab.selectionCenterZ': '選取中心 Z',
  'hudChrome.naturePlacementLab.rotationDelta': '旋轉增量',
  'hudChrome.naturePlacementLab.scaleFactor': '縮放倍率',
  'hudChrome.naturePlacementLab.groundOffsetDelta': '地面偏移增量',
  'hudChrome.naturePlacementLab.totalPlacements': '物件總數：{count}',
  'hudChrome.naturePlacementLab.visiblePlacements': '可見物件：{count}',
  'hudChrome.naturePlacementLab.statisticsSelected': '已選取：{count}',
  'hudChrome.naturePlacementLab.placementsByAsset': '依資源：{counts}',
  'hudChrome.naturePlacementLab.placementsByLayer': '依圖層：{counts}',
  'hudChrome.naturePlacementLab.estimatedTriangles': '估計三角形：{count}',
  'hudChrome.naturePlacementLab.estimatedMediaBytes': '估計媒體大小：{count}',
  'hudChrome.naturePlacementLab.statusLockedLayer': '圖層已鎖定',
  'hudChrome.naturePlacementLab.statusOperationRejected': '操作遭拒',
  'hudChrome.naturePlacementLab.statusProjectCreated': '專案已建立',
  'hudChrome.naturePlacementLab.statusProjectRenamed': '專案已重新命名',
  'hudChrome.naturePlacementLab.statusProjectSaved': '專案已儲存',
  'hudChrome.naturePlacementLab.statusProjectLoaded': '專案已載入',
  'hudChrome.naturePlacementLab.statusProjectDeleted': '專案已刪除',
  'hudChrome.naturePlacementLab.statusProjectFailed': '專案操作失敗',
  'hudChrome.naturePlacementLab.statusLayerCreated': '圖層已建立',
  'hudChrome.naturePlacementLab.statusLayerRenamed': '圖層已重新命名',
  'hudChrome.naturePlacementLab.statusLayerDeleted': '圖層已刪除',
  'hudChrome.naturePlacementLab.statusLayerCleared': '圖層已清空',
  'hudChrome.naturePlacementLab.statusLayerUpdated': '圖層已更新',
  'hudChrome.naturePlacementLab.statusLayerChanged': '圖層已變更',
  'hudChrome.naturePlacementLab.statusGroupCreated': '群組已建立',
  'hudChrome.naturePlacementLab.statusGroupRenamed': '群組已重新命名',
  'hudChrome.naturePlacementLab.statusGroupDuplicated': '群組已複製',
  'hudChrome.naturePlacementLab.statusGroupDeleted': '群組已刪除',
  'hudChrome.naturePlacementLab.title': '自然放置實驗室',
  'hudChrome.naturePlacementLab.assetsSection': '資源',
  'hudChrome.naturePlacementLab.selectionSection': '選擇',
  'hudChrome.naturePlacementLab.transformSection': '變換',
  'hudChrome.naturePlacementLab.snappingSection': '吸附',
  'hudChrome.naturePlacementLab.historySection': '歷史',
  'hudChrome.naturePlacementLab.importExportSection': '匯入與匯出',
  'hudChrome.naturePlacementLab.apply': '套用',
  'hudChrome.naturePlacementLab.resetTransform': '重設變換',
  ...
  'hudChrome.naturePlacementLab.assetId': '資源 ID',
  ...
  'hudChrome.naturePlacementLab.rotationYDegrees': 'Y 軸旋轉（度）',
  'hudChrome.naturePlacementLab.scale': '縮放',
  'hudChrome.naturePlacementLab.groundOffsetY': '地面 Y 偏移',
  'hudChrome.naturePlacementLab.showGrid': '顯示網格',
  'hudChrome.naturePlacementLab.hideGrid': '隱藏網格',
  'hudChrome.naturePlacementLab.gridSize': '網格單元大小',
  'hudChrome.naturePlacementLab.snapPosition': '位置吸附',
  'hudChrome.naturePlacementLab.snapRotation': '旋轉吸附',
  'hudChrome.naturePlacementLab.snapScale': '縮放吸附',
  'hudChrome.naturePlacementLab.snapToGround': '吸附到地面',
  'hudChrome.naturePlacementLab.rotationStep': '旋轉步長（度）',
  'hudChrome.naturePlacementLab.scaleStep': '縮放步長',
  'hudChrome.naturePlacementLab.undo': '復原',
  ...
  'hudChrome.naturePlacementLab.historyState': '復原：{undo}。重做：{redo}。',
  'hudChrome.naturePlacementLab.assetsAria': '實驗室資源',
  'hudChrome.naturePlacementLab.placeSelected': '放置所選資源',
  'hudChrome.naturePlacementLab.deleteSelected': '刪除所選物件',
  'hudChrome.naturePlacementLab.clearAll': '全部清除',
  'hudChrome.naturePlacementLab.exportJson': '匯出 JSON',
  'hudChrome.naturePlacementLab.importJson': '匯入 JSON',
  'hudChrome.naturePlacementLab.selectedObject': '所選物件：{id}',
  'hudChrome.naturePlacementLab.selectedAsset': '所選資源：{assetId}',
  'hudChrome.naturePlacementLab.noAssetSelected': '未選擇資源',
  'hudChrome.naturePlacementLab.cancelPlacement': '取消放置',
  'hudChrome.naturePlacementLab.placementsCount': '實驗室放置數：{count}',
  'hudChrome.naturePlacementLab.help':
    'Ctrl+Z/Y 復原和重做。Ctrl+D 複製。G 切換網格。X 切換位置吸附。T 放置到地面。R 旋轉。滾輪或加減鍵縮放。Page Up 和 Page Down 調整高度。',
  'hudChrome.naturePlacementLab.statusReady': '就緒',
  'hudChrome.naturePlacementLab.statusAssetSelected': '已選擇 {assetId}',
  'hudChrome.naturePlacementLab.statusSelectAssetFirst': '請先選擇資源',
  'hudChrome.naturePlacementLab.statusPlacementActive': '放置模式已啟用',
  'hudChrome.naturePlacementLab.statusPlacementCancelled': '已取消放置',
  'hudChrome.naturePlacementLab.statusPlacementMoved': '物件已移動',
  'hudChrome.naturePlacementLab.statusNoTerrain': '沒有有效的地形點',
  'hudChrome.naturePlacementLab.statusAssetPlaced': '已放置 {assetId}',
  'hudChrome.naturePlacementLab.statusPlacementSelected': '已選擇 {id}',
  'hudChrome.naturePlacementLab.statusNoSelection': '未選擇放置物件',
  'hudChrome.naturePlacementLab.statusPlacementDeleted': '放置物件已刪除',
  'hudChrome.naturePlacementLab.statusCleared': '已清除所有實驗室放置物件',
  'hudChrome.naturePlacementLab.statusExported': '已匯出 {count} 個放置物件',
  'hudChrome.naturePlacementLab.statusImported': '已匯入 {count} 個放置物件',
  'hudChrome.naturePlacementLab.statusImportFailed': '放置資料匯入失敗',
  'hudChrome.naturePlacementLab.statusTransformAdjusted': '變換已調整',
  'hudChrome.naturePlacementLab.statusNothingToUndo': '沒有可復原的操作',
  'hudChrome.naturePlacementLab.statusNothingToRedo': '沒有可重做的操作',
  'hudChrome.naturePlacementLab.statusUndone': '已復原上次編輯',
  'hudChrome.naturePlacementLab.statusRedone': '已恢復上次編輯',
  'hudChrome.naturePlacementLab.statusDuplicateFailed': '無法複製所選放置物件',
  'hudChrome.naturePlacementLab.statusDuplicated': '已複製並選擇 {id}',
  'hudChrome.naturePlacementLab.statusTransformRejected': '變換被拒絕',
  'hudChrome.naturePlacementLab.statusTransformApplied': '變換已套用',
  'hudChrome.naturePlacementLab.statusTransformReset': '變換已重設為資源預設值',
  'hudChrome.naturePlacementLab.statusPlacedOnGround': '放置物件已對齊現有地形',
  'hudChrome.naturePlacementLab.statusPreferencesSaved': '編輯器選項已更新',
  'hudChrome.naturePlacementLab.statusFiniteRequired': '{field} 必須是有限數字',
  'hudChrome.naturePlacementLab.statusOutsideLimits': '{field} 必須介於 {min} 和 {max} 之間',
  'hudChrome.startZoneTerrainSurvey.title': '起始區域地形勘測',
  'hudChrome.startZoneTerrainSurvey.terrainSection': '地形分析',
  'hudChrome.startZoneTerrainSurvey.footprintSection': '建築占地',
  'hudChrome.startZoneTerrainSurvey.anchorSection': '錨點',
  'hudChrome.startZoneTerrainSurvey.resolution': '網格解析度',
  'hudChrome.startZoneTerrainSurvey.selectedTemplate': '建築範本',
  'hudChrome.startZoneTerrainSurvey.rotation': 'Y 軸旋轉',
  'hudChrome.startZoneTerrainSurvey.showGrid': '顯示網格',
  'hudChrome.startZoneTerrainSurvey.hideGrid': '隱藏網格',
  ...
  'hudChrome.startZoneTerrainSurvey.centralPlaza': '中央廣場 20 x 20',
  'hudChrome.startZoneTerrainSurvey.road': '道路 4 x 12',
  'hudChrome.startZoneTerrainSurvey.minimumHeight': '最低高度：{value} 公尺',
  'hudChrome.startZoneTerrainSurvey.maximumHeight': '最高高度：{value} 公尺',
  ...
  'hudChrome.startZoneTerrainSurvey.compatibleSurfaces': '相容區域：{count}',
  'hudChrome.startZoneTerrainSurvey.anchorsCount': '已儲存錨點：{count}',
  'hudChrome.startZoneTerrainSurvey.verdict': '游標位置判定：{verdict}',
  'hudChrome.startZoneTerrainSurvey.compatible': '相容',
  'hudChrome.startZoneTerrainSurvey.incompatible': '不相容',
  'hudChrome.startZoneTerrainSurvey.noTerrain': '在勘測地形範圍之外',
  'hudChrome.startZoneTerrainSurvey.cornerDifference': '{corner}：{value} 公尺',
  'hudChrome.startZoneTerrainSurvey.anchorName': '錨點名稱',
  'hudChrome.startZoneTerrainSurvey.anchorNameDefault': '勘測錨點',
  'hudChrome.startZoneTerrainSurvey.proposedType': '建議類型',
  'hudChrome.startZoneTerrainSurvey.notes': '備註',
  'hudChrome.startZoneTerrainSurvey.saveAnchor': '儲存錨點',
  'hudChrome.startZoneTerrainSurvey.clearAnchors': '清除錨點',
  'hudChrome.startZoneTerrainSurvey.exportReport': '匯出 JSON 報告',
  'hudChrome.startZoneTerrainSurvey.typeBuildingSmall': '小型建築',
  'hudChrome.startZoneTerrainSurvey.typeBuildingMedium': '中型建築',
  'hudChrome.startZoneTerrainSurvey.typeBuildingLarge': '大型建築',
  'hudChrome.startZoneTerrainSurvey.typePlaza': '廣場',
  'hudChrome.startZoneTerrainSurvey.typeRoad': '道路',
  'hudChrome.startZoneTerrainSurvey.typeDecorative': '裝飾',
  'hudChrome.startZoneTerrainSurvey.typeAvoid': '避開',
  'hudChrome.startZoneTerrainSurvey.statusAnchorSaved': '錨點已儲存在本機',
  'hudChrome.startZoneTerrainSurvey.statusAnchorRejected': '無法儲存錨點',
  'hudChrome.startZoneTerrainSurvey.statusAnchorsCleared': '本機錨點已清除',
  ...
  'seo.officialLabel': 'World of CodexCraft 官方網站',
  'seo.officialBody':
  ...
  'playerCard.shareText':
    '我正在 World of CodexCraft 中鑄就傳說：{level}級 {className}{tierBit}。加入我的世界：',
  ...
  'controls.chat': '開啟對話框',
  'seo.title': 'World of CodexCraft：經典風格網頁 MMO',
  'seo.description':
    '在 World of CodexCraft 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的世界，提升職業等級並擊敗敵人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人遊戲',
  ...
  'a11y.githubProject': '開啟 World of CodexCraft 的 GitHub 專案',
  'a11y.discordCommunity': '加入 World of CodexCraft 的 Discord 社群',
  'a11y.donateProject': '捐贈支持 World of CodexCraft',
  ...
  'mobilePreflight.iosOpenStep': '從新的主畫面圖示開啟 World of CodexCraft。',
  ...
  'mode.play': '開始遊戲',
  'mode.playAria': '遊玩 World of CodexCraft',
  ...
  'guide.worldPage.intro':
    'World of CodexCraft 是一片你需徒步橫越的連綿大地，三大區域由南向北排列。沒有快速旅行，所以旅程本身就是冒險的一部分。',
  ...
  'hudChrome.nativeUpdate.body': 'World of CodexCraft 有新版本可用。立即更新以取得最新修正與改進。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'World of CodexCraft {version} 版本已可用。立即更新以取得最新修正與改進。',
  ...
  'desktop.crash.fatalBody': 'World of CodexCraft 發生未預期的錯誤，必須關閉。',
  'editor.appTitle': '地圖編輯器',
  'editor.docTitle': '地圖編輯器 - World of CodexCraft',
