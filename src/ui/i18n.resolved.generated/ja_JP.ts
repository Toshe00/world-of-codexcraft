...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    "naturePlacementLab": {
      ...
      "selectionSection": "選択",
      "transformSection": "変換",
      "snappingSection": "スナップ",
      "historySection": "履歴",
      "importExportSection": "インポートとエクスポート",
      ...
      "projectNamePrompt": "プロジェクト名",
      "confirmDeleteProject": "現在のローカルプロジェクトを削除しますか？",
      "untitledProjectName": "名称未設定プロジェクト",
      "importedProjectName": "インポートした配置",
      "createLayer": "レイヤーを作成",
      "renameLayer": "レイヤー名を変更",
      "deleteLayer": "レイヤーを削除",
      "deleteLayerPlacements": "レイヤーの配置を削除",
      "layerNamePrompt": "レイヤー名",
      ...
      "confirmDeleteLayer": "この空のレイヤーを削除しますか？",
      "confirmDeleteLayerPlacements": "このレイヤーの配置をすべて削除しますか？",
      "visible": "表示",
      "locked": "ロック済み",
      "selectLayer": "レイヤーを選択",
      "selectAll": "すべて選択",
      ...
      "selectByAsset": "アセット別に選択",
      "moveToLayer": "レイヤーへ移動",
      "selectedCount": "選択済み：{count}",
      "selectedAssets": "アセット：{assets}",
      "selectedLayers": "レイヤー：{layers}",
      ...
      "deleteGroup": "グループを削除",
      "deleteGroupAndPlacements": "グループと配置を削除",
      "groupNamePrompt": "グループ名",
      "confirmDeleteGroupPlacements": "このグループとすべての配置を削除しますか？",
      "groupCopyName": "{name} のコピー",
      "groupSummary": "{name}（{count}）",
      "applyGroupTransform": "グループ変換を適用",
      "selectionCenterX": "選択中心 X",
      "selectionCenterY": "選択中心 Y",
      "selectionCenterZ": "選択中心 Z",
      "rotationDelta": "回転差分",
      "scaleFactor": "スケール倍率",
      "groundOffsetDelta": "地面オフセット差分",
      "totalPlacements": "配置総数：{count}",
      "visiblePlacements": "表示中：{count}",
      "statisticsSelected": "選択済み：{count}",
      "placementsByAsset": "アセット別：{counts}",
      "placementsByLayer": "レイヤー別：{counts}",
      "estimatedTriangles": "推定三角形数：{count}",
      "estimatedMediaBytes": "推定メディアサイズ：{count}",
      "assetsAria": "ラボ用アセット",
      ...
      "positionY": "位置 Y",
      "positionZ": "位置 Z",
      "rotationYDegrees": "Y 回転（度）",
      "scale": "スケール",
      "groundOffsetY": "地面 Y オフセット",
      "showGrid": "グリッドを表示",
      "hideGrid": "グリッドを非表示",
      "gridSize": "グリッドセルサイズ",
      "snapPosition": "位置をスナップ",
      "snapRotation": "回転をスナップ",
      "snapScale": "スケールをスナップ",
      "snapToGround": "地面にスナップ",
      "rotationStep": "回転ステップ（度）",
      "scaleStep": "スケールステップ",
      "undo": "元に戻す",
      "redo": "やり直す",
      "available": "使用可能",
      "unavailable": "使用不可",
      "historyState": "元に戻す：{undo}。やり直す：{redo}。",
      ...
      "help": "Ctrl+Z/Y で元に戻す・やり直す。Ctrl+D で複製。G でグリッド、X で位置スナップを切り替え。T で地面に配置。R で回転。ホイールまたはプラスとマイナスで拡縮。Page Up と Page Down で高さを調整。",
      "statusReady": "準備完了",
      ...
      "statusNothingToUndo": "元に戻す編集はありません",
      "statusNothingToRedo": "やり直す編集はありません",
      "statusUndone": "直前の編集を元に戻しました",
      "statusRedone": "直前の編集を復元しました",
      "statusDuplicateFailed": "選択した配置を複製できませんでした",
      "statusDuplicated": "{id} を複製して選択しました",
      "statusTransformRejected": "変換が拒否されました",
      "statusTransformApplied": "変換を適用しました",
      "statusTransformReset": "変換をアセットの既定値に戻しました",
      "statusPlacedOnGround": "配置を既存の地形に合わせました",
      "statusPreferencesSaved": "エディター設定を更新しました",
      "statusFiniteRequired": "{field} は有限数である必要があります",
      "statusOutsideLimits": "{field} は {min} から {max} の範囲で指定してください",
      "statusLockedLayer": "レイヤーはロックされています",
      "statusOperationRejected": "操作は拒否されました",
      "statusProjectCreated": "プロジェクトを作成しました",
      "statusProjectRenamed": "プロジェクト名を変更しました",
      "statusProjectSaved": "プロジェクトを保存しました",
      "statusProjectLoaded": "プロジェクトを読み込みました",
      "statusProjectDeleted": "プロジェクトを削除しました",
      "statusProjectFailed": "プロジェクト操作に失敗しました",
      "statusLayerCreated": "レイヤーを作成しました",
      "statusLayerRenamed": "レイヤー名を変更しました",
      "statusLayerDeleted": "レイヤーを削除しました",
      "statusLayerCleared": "レイヤーを空にしました",
      "statusLayerUpdated": "レイヤーを更新しました",
      "statusLayerChanged": "レイヤーを変更しました",
      "statusGroupCreated": "グループを作成しました",
      "statusGroupRenamed": "グループ名を変更しました",
    ...
    "startZoneTerrainSurvey": {
      "title": "開始ゾーン地形調査",
      "terrainSection": "地形分析",
      "footprintSection": "建物の設置面",
      "anchorSection": "アンカーポイント",
      "resolution": "グリッド解像度",
      "selectedTemplate": "建物テンプレート",
      "rotation": "Y 軸回転",
      "showGrid": "グリッドを表示",
      "hideGrid": "グリッドを非表示",
      "smallHouse": "小型住宅 6 x 6",
      "mediumHouse": "中型住宅 10 x 8",
      "largeHouse": "大型住宅 14 x 12",
      "centralPlaza": "中央広場 20 x 20",
      "road": "道路 4 x 12",
      "minimumHeight": "最低高度: {value} m",
      "maximumHeight": "最高高度: {value} m",
      "averageSlope": "平均傾斜: {value} 度",
      "maximumSlope": "最大傾斜: {value} 度",
      "flatSurface": "平坦な地形: {value}%",
      "compatibleSurfaces": "適合エリア: {count}",
      "anchorsCount": "保存済みアンカー: {count}",
      "verdict": "カーソル位置の判定: {verdict}",
      "compatible": "適合",
      "incompatible": "不適合",
      "noTerrain": "調査対象の地形範囲外",
      "cornerDifference": "{corner}: {value} m",
      "anchorName": "アンカー名",
      "anchorNameDefault": "調査アンカー",
      "proposedType": "提案タイプ",
      "notes": "メモ",
      "saveAnchor": "アンカーポイントを保存",
      "clearAnchors": "アンカーポイントを消去",
      "exportReport": "JSON レポートをエクスポート",
      "typeBuildingSmall": "小型建物",
      "typeBuildingMedium": "中型建物",
      "typeBuildingLarge": "大型建物",
      "typePlaza": "広場",
      "typeRoad": "道路",
      "typeDecorative": "装飾",
      "typeAvoid": "回避",
      "statusAnchorSaved": "アンカーポイントをローカルに保存しました",
      "statusAnchorRejected": "アンカーポイントを保存できませんでした",
      "statusAnchorsCleared": "ローカルのアンカーポイントを消去しました"
    },
    ...
    "nativeUpdate": {
      "title": "アップデートがあります",
      "body": "World of CodexCraft の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。",
      "bodyWithVersion": "World of CodexCraft のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。",
      "notNow": "後で",
      "update": "更新"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "World of CodexCraftは、自らの足で歩いて渡る一続きの大地です。南から北へと3つのゾーンが連なっています。ファストトラベルはなく、その旅路こそが冒険の一部です。",
      "hub": "拠点",
      "mapHeading": "北への道",
  ...
  "editor": {
    "appTitle": "マップエディター",
    "docTitle": "マップエディター - World of CodexCraft",
    "untitledMap": "無題のマップ",
  ...
  "mode": {
    ...
    "serverOffline": "オフライン",
    "play": "プレイ",
    "playAria": "World of CodexCraftをプレイ",
    "serverLabel": "ワールドを選択",
  ...
  "playerCard": {
    ...
    "shareText": "World of CodexCraftで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:",
    "nativeShareTitle": "CodexCraftの世界",
  ...
  "seo": {
    "title": "World of CodexCraft: クラシック風Web MMO",
    "description": "ブラウザで直接遊べるクラシック風マイクロMMO、World of CodexCraft で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。",
    "genre": "MMORPG",
    "playMode": "マルチプレイヤー",
    "applicationCategory": "ゲーム",
    "operatingSystem": "Webブラウザ",
    "officialLabel": "World of CodexCraft 公式サイト",
  ...
  "a11y": {
    ...
    "githubProject": "GitHubでWorld of CodexCraftプロジェクトを開く",
    "discordCommunity": "World of CodexCraftのDiscordコミュニティに参加",
    "donateProject": "World of CodexCraftを支援するために寄付"
  },
  "loading": {
    "world": "世界を読み込み中...",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "再読み込み",
      "quit": "終了",
      "fatalBody": "World of CodexCraft で予期しないエラーが発生したため、終了します。"
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "新しいホーム画面アイコンからWorld of CodexCraftを開きます。",
