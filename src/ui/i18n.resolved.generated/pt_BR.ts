...
export const pt_BR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Uma nova versão do World of CodexCraft está disponível. Atualize agora para receber as últimas correções e melhorias.",
      "bodyWithVersion": "A versão {version} do World of CodexCraft está disponível. Atualize agora para receber as últimas correções e melhorias.",
      "notNow": "Agora não",
      "update": "Atualizar"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "O mundo",
      "intro": "World of CodexCraft é uma terra contínua que você atravessa a pé, três zonas dispostas de sul a norte. Não há viagem rápida, então a jornada faz parte da aventura.",
  ...
  "mode": {
    ...
    "play": "Jogar",
    "playAria": "Jogar World of CodexCraft",
  ...
  "playerCard": {
    ...
    "shareText": "Estou forjando minha lenda em World of CodexCraft: nível {level} {className}{tierBit}. Entre no meu mundo:",
  ...
  "seo": {
    "title": "World of CodexCraft: MMO web em estilo clássico",
    "description": "Embarque em uma aventura épica em World of CodexCraft, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um mundo compartilhado persistente, evolua classes e derrote inimigos!",
    "genre": "MMORPG",
    "playMode": "Multijogador",
    "applicationCategory": "Jogo",
    "operatingSystem": "Navegador web",
    "officialLabel": "Site oficial de World of CodexCraft",
  ...
  "a11y": {
    ...
    "githubProject": "Abrir o projeto World of CodexCraft no GitHub",
    "discordCommunity": "Entrar na comunidade World of CodexCraft no Discord",
    "donateProject": "Doar para apoiar World of CodexCraft"
  },
  "loading": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recarregar",
      "quit": "Sair",
      "fatalBody": "O World of CodexCraft encontrou um erro inesperado e precisa fechar."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Abra World of CodexCraft pelo novo ícone na tela inicial.",
    ...
    "androidOpenStep": "Abra World of CodexCraft pelo novo ícone.",
  ...
  "serverUnavailable": {
    "title": "World of CodexCraft - Mundo indisponível",
