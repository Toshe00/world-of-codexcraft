...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.naturePlacementLab.help':
    'Левая кнопка размещает или перетаскивает. Правая кнопка или Escape отменяет. R вращает. Колесо или плюс и минус меняют масштаб. Page Up и Page Down меняют высоту. Shift включает точную настройку.',
