...
const RENDER_PURE_CORES = [
  ...
  'src/render/nature_placement_lab/placement_group_transform_core.ts',
  'src/render/nature_placement_lab/placement_project_core.ts',
  'src/render/nature_placement_lab/placement_statistics_core.ts',
  ...
  'src/render/start_zone_terrain_survey/terrain_survey_core.ts',
