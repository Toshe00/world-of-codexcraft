...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  'hudChrome.naturePlacementLab.untitledProjectName': 'Проект без названия',
  'hudChrome.naturePlacementLab.importedProjectName': 'Импортированные объекты',
  'hudChrome.naturePlacementLab.groupCopyName': 'Копия {name}',
  'hudChrome.naturePlacementLab.groupSummary': '{name} ({count})',
  'hudChrome.naturePlacementLab.projectsSection': 'Проекты',
  'hudChrome.naturePlacementLab.layersSection': 'Слои',
  'hudChrome.naturePlacementLab.groupsSection': 'Группы',
  'hudChrome.naturePlacementLab.statisticsSection': 'Статистика',
  'hudChrome.naturePlacementLab.newProject': 'Новый проект',
  'hudChrome.naturePlacementLab.renameProject': 'Переименовать проект',
  'hudChrome.naturePlacementLab.saveProject': 'Сохранить проект',
  'hudChrome.naturePlacementLab.saveProjectAs': 'Сохранить проект как',
  'hudChrome.naturePlacementLab.loadProject': 'Загрузить проект',
  'hudChrome.naturePlacementLab.deleteProject': 'Удалить проект',
  'hudChrome.naturePlacementLab.projectNamePrompt': 'Название проекта',
  'hudChrome.naturePlacementLab.confirmDeleteProject': 'Удалить текущий локальный проект?',
  'hudChrome.naturePlacementLab.createLayer': 'Создать слой',
  'hudChrome.naturePlacementLab.renameLayer': 'Переименовать слой',
  'hudChrome.naturePlacementLab.deleteLayer': 'Удалить слой',
  'hudChrome.naturePlacementLab.deleteLayerPlacements': 'Удалить объекты слоя',
  'hudChrome.naturePlacementLab.layerNamePrompt': 'Название слоя',
  'hudChrome.naturePlacementLab.confirmDeleteLayer': 'Удалить этот пустой слой?',
  'hudChrome.naturePlacementLab.confirmDeleteLayerPlacements': 'Удалить все объекты этого слоя?',
  'hudChrome.naturePlacementLab.visible': 'Видимый',
  'hudChrome.naturePlacementLab.locked': 'Заблокирован',
  'hudChrome.naturePlacementLab.selectLayer': 'Выбрать слой',
  'hudChrome.naturePlacementLab.selectAll': 'Выбрать всё',
  'hudChrome.naturePlacementLab.deselectAll': 'Снять выделение',
  'hudChrome.naturePlacementLab.invertSelection': 'Инвертировать выбор',
  'hudChrome.naturePlacementLab.selectByAsset': 'Выбрать по объекту',
  'hudChrome.naturePlacementLab.moveToLayer': 'Переместить в слой',
  'hudChrome.naturePlacementLab.selectedCount': 'Выбрано: {count}',
  'hudChrome.naturePlacementLab.selectedAssets': 'Объекты: {assets}',
  'hudChrome.naturePlacementLab.selectedLayers': 'Слои: {layers}',
  'hudChrome.naturePlacementLab.groupSelection': 'Сгруппировать выбранное',
  'hudChrome.naturePlacementLab.ungroup': 'Разгруппировать',
  'hudChrome.naturePlacementLab.renameGroup': 'Переименовать группу',
  'hudChrome.naturePlacementLab.selectGroup': 'Выбрать группу',
  'hudChrome.naturePlacementLab.duplicateGroup': 'Дублировать группу',
  'hudChrome.naturePlacementLab.deleteGroup': 'Удалить группу',
  'hudChrome.naturePlacementLab.deleteGroupAndPlacements': 'Удалить группу и объекты',
  'hudChrome.naturePlacementLab.groupNamePrompt': 'Название группы',
  'hudChrome.naturePlacementLab.confirmDeleteGroupPlacements':
    'Удалить эту группу и все её объекты?',
  'hudChrome.naturePlacementLab.applyGroupTransform': 'Применить преобразование группы',
  'hudChrome.naturePlacementLab.selectionCenterX': 'Центр выбора X',
  'hudChrome.naturePlacementLab.selectionCenterY': 'Центр выбора Y',
  'hudChrome.naturePlacementLab.selectionCenterZ': 'Центр выбора Z',
  'hudChrome.naturePlacementLab.rotationDelta': 'Изменение поворота',
  'hudChrome.naturePlacementLab.scaleFactor': 'Коэффициент масштаба',
  'hudChrome.naturePlacementLab.groundOffsetDelta': 'Изменение смещения от земли',
  'hudChrome.naturePlacementLab.totalPlacements': 'Всего объектов: {count}',
  'hudChrome.naturePlacementLab.visiblePlacements': 'Видимых объектов: {count}',
  'hudChrome.naturePlacementLab.statisticsSelected': 'Выбрано: {count}',
  'hudChrome.naturePlacementLab.placementsByAsset': 'По объектам: {counts}',
  'hudChrome.naturePlacementLab.placementsByLayer': 'По слоям: {counts}',
  'hudChrome.naturePlacementLab.estimatedTriangles': 'Оценка треугольников: {count}',
  'hudChrome.naturePlacementLab.estimatedMediaBytes': 'Оценка размера медиа: {count}',
  'hudChrome.naturePlacementLab.statusLockedLayer': 'Слой заблокирован',
  'hudChrome.naturePlacementLab.statusOperationRejected': 'Операция отклонена',
  'hudChrome.naturePlacementLab.statusProjectCreated': 'Проект создан',
  'hudChrome.naturePlacementLab.statusProjectRenamed': 'Проект переименован',
  'hudChrome.naturePlacementLab.statusProjectSaved': 'Проект сохранён',
  'hudChrome.naturePlacementLab.statusProjectLoaded': 'Проект загружен',
  'hudChrome.naturePlacementLab.statusProjectDeleted': 'Проект удалён',
  'hudChrome.naturePlacementLab.statusProjectFailed': 'Операция с проектом не выполнена',
  'hudChrome.naturePlacementLab.statusLayerCreated': 'Слой создан',
  'hudChrome.naturePlacementLab.statusLayerRenamed': 'Слой переименован',
  'hudChrome.naturePlacementLab.statusLayerDeleted': 'Слой удалён',
  'hudChrome.naturePlacementLab.statusLayerCleared': 'Слой очищен',
  'hudChrome.naturePlacementLab.statusLayerUpdated': 'Слой обновлён',
  'hudChrome.naturePlacementLab.statusLayerChanged': 'Слой изменён',
  'hudChrome.naturePlacementLab.statusGroupCreated': 'Группа создана',
  'hudChrome.naturePlacementLab.statusGroupRenamed': 'Группа переименована',
  'hudChrome.naturePlacementLab.statusGroupDuplicated': 'Группа дублирована',
  'hudChrome.naturePlacementLab.statusGroupDeleted': 'Группа удалена',
  'hudChrome.naturePlacementLab.title': 'Лаборатория природных объектов',
  'hudChrome.naturePlacementLab.assetsSection': 'Объекты',
  'hudChrome.naturePlacementLab.selectionSection': 'Выбор',
  'hudChrome.naturePlacementLab.transformSection': 'Преобразование',
  'hudChrome.naturePlacementLab.snappingSection': 'Привязка',
  'hudChrome.naturePlacementLab.historySection': 'История',
  'hudChrome.naturePlacementLab.importExportSection': 'Импорт и экспорт',
  'hudChrome.naturePlacementLab.apply': 'Применить',
  'hudChrome.naturePlacementLab.resetTransform': 'Сбросить преобразование',
  'hudChrome.naturePlacementLab.placeOnGround': 'Поставить на землю',
  'hudChrome.naturePlacementLab.duplicate': 'Дублировать',
  'hudChrome.naturePlacementLab.id': 'ID',
  'hudChrome.naturePlacementLab.assetId': 'ID объекта',
  'hudChrome.naturePlacementLab.positionX': 'Позиция X',
  'hudChrome.naturePlacementLab.positionY': 'Позиция Y',
  'hudChrome.naturePlacementLab.positionZ': 'Позиция Z',
  'hudChrome.naturePlacementLab.rotationYDegrees': 'Поворот Y (градусы)',
  'hudChrome.naturePlacementLab.scale': 'Масштаб',
  'hudChrome.naturePlacementLab.groundOffsetY': 'Смещение Y от земли',
  'hudChrome.naturePlacementLab.showGrid': 'Показать сетку',
  'hudChrome.naturePlacementLab.hideGrid': 'Скрыть сетку',
  'hudChrome.naturePlacementLab.gridSize': 'Размер ячейки сетки',
  'hudChrome.naturePlacementLab.snapPosition': 'Привязка позиции',
  'hudChrome.naturePlacementLab.snapRotation': 'Привязка поворота',
  'hudChrome.naturePlacementLab.snapScale': 'Привязка масштаба',
  'hudChrome.naturePlacementLab.snapToGround': 'Привязка к земле',
  'hudChrome.naturePlacementLab.rotationStep': 'Шаг поворота (градусы)',
  'hudChrome.naturePlacementLab.scaleStep': 'Шаг масштаба',
  'hudChrome.naturePlacementLab.undo': 'Отменить',
  'hudChrome.naturePlacementLab.redo': 'Повторить',
  'hudChrome.naturePlacementLab.available': 'доступно',
  'hudChrome.naturePlacementLab.unavailable': 'недоступно',
  'hudChrome.naturePlacementLab.historyState': 'Отмена: {undo}. Повтор: {redo}.',
  'hudChrome.naturePlacementLab.assetsAria': 'Объекты лаборатории',
  'hudChrome.naturePlacementLab.placeSelected': 'Разместить выбранное',
  'hudChrome.naturePlacementLab.deleteSelected': 'Удалить выбранное',
  'hudChrome.naturePlacementLab.clearAll': 'Очистить всё',
  'hudChrome.naturePlacementLab.exportJson': 'Экспорт JSON',
  'hudChrome.naturePlacementLab.importJson': 'Импорт JSON',
  'hudChrome.naturePlacementLab.selectedObject': 'Выбранный объект: {id}',
  'hudChrome.naturePlacementLab.selectedAsset': 'Выбранный ресурс: {assetId}',
  'hudChrome.naturePlacementLab.noAssetSelected': 'Ресурс не выбран',
  'hudChrome.naturePlacementLab.cancelPlacement': 'Отменить размещение',
  'hudChrome.naturePlacementLab.placementsCount': 'Объектов лаборатории: {count}',
  'hudChrome.naturePlacementLab.help':
    'Ctrl+Z/Y отменяет и повторяет. Ctrl+D дублирует. G включает сетку. X включает привязку позиции. T ставит на землю. R вращает. Колесо или плюс и минус меняют масштаб. Page Up и Page Down меняют высоту.',
  'hudChrome.naturePlacementLab.statusReady': 'Готово',
  'hudChrome.naturePlacementLab.statusAssetSelected': 'Выбрано: {assetId}',
  'hudChrome.naturePlacementLab.statusSelectAssetFirst': 'Сначала выберите ресурс',
  'hudChrome.naturePlacementLab.statusPlacementActive': 'Режим размещения включён',
  'hudChrome.naturePlacementLab.statusPlacementCancelled': 'Размещение отменено',
  'hudChrome.naturePlacementLab.statusPlacementMoved': 'Объект перемещён',
  'hudChrome.naturePlacementLab.statusNoTerrain': 'Нет подходящей точки рельефа',
  'hudChrome.naturePlacementLab.statusAssetPlaced': 'Размещено: {assetId}',
  'hudChrome.naturePlacementLab.statusPlacementSelected': 'Выбрано: {id}',
  'hudChrome.naturePlacementLab.statusNoSelection': 'Объект не выбран',
  'hudChrome.naturePlacementLab.statusPlacementDeleted': 'Объект удалён',
  'hudChrome.naturePlacementLab.statusCleared': 'Все объекты лаборатории удалены',
  'hudChrome.naturePlacementLab.statusExported': 'Экспортировано объектов: {count}',
  'hudChrome.naturePlacementLab.statusImported': 'Импортировано объектов: {count}',
  'hudChrome.naturePlacementLab.statusImportFailed': 'Не удалось импортировать объекты',
  'hudChrome.naturePlacementLab.statusTransformAdjusted': 'Преобразование изменено',
  'hudChrome.naturePlacementLab.statusNothingToUndo': 'Нечего отменять',
  'hudChrome.naturePlacementLab.statusNothingToRedo': 'Нечего повторять',
  'hudChrome.naturePlacementLab.statusUndone': 'Последнее изменение отменено',
  'hudChrome.naturePlacementLab.statusRedone': 'Последнее изменение восстановлено',
  'hudChrome.naturePlacementLab.statusDuplicateFailed': 'Не удалось дублировать выбранный объект',
  'hudChrome.naturePlacementLab.statusDuplicated': '{id} дублирован и выбран',
  'hudChrome.naturePlacementLab.statusTransformRejected': 'Преобразование отклонено',
  'hudChrome.naturePlacementLab.statusTransformApplied': 'Преобразование применено',
  'hudChrome.naturePlacementLab.statusTransformReset':
    'Преобразование сброшено к значениям объекта',
  'hudChrome.naturePlacementLab.statusPlacedOnGround': 'Объект выровнен по существующему рельефу',
  'hudChrome.naturePlacementLab.statusPreferencesSaved': 'Настройки редактора обновлены',
  'hudChrome.naturePlacementLab.statusFiniteRequired': '{field}: требуется конечное число',
  'hudChrome.naturePlacementLab.statusOutsideLimits':
    '{field}: значение должно быть от {min} до {max}',
  'hudChrome.startZoneTerrainSurvey.title': 'Исследование рельефа стартовой зоны',
  'hudChrome.startZoneTerrainSurvey.terrainSection': 'Анализ рельефа',
  'hudChrome.startZoneTerrainSurvey.footprintSection': 'Пятно застройки',
  'hudChrome.startZoneTerrainSurvey.anchorSection': 'Опорные точки',
  'hudChrome.startZoneTerrainSurvey.resolution': 'Разрешение сетки',
  'hudChrome.startZoneTerrainSurvey.selectedTemplate': 'Шаблон здания',
  'hudChrome.startZoneTerrainSurvey.rotation': 'Поворот по оси Y',
  'hudChrome.startZoneTerrainSurvey.showGrid': 'Показать сетку',
  'hudChrome.startZoneTerrainSurvey.hideGrid': 'Скрыть сетку',
  'hudChrome.startZoneTerrainSurvey.smallHouse': 'Малый дом 6 x 6',
  'hudChrome.startZoneTerrainSurvey.mediumHouse': 'Средний дом 10 x 8',
  'hudChrome.startZoneTerrainSurvey.largeHouse': 'Большой дом 14 x 12',
  'hudChrome.startZoneTerrainSurvey.centralPlaza': 'Центральная площадь 20 x 20',
  'hudChrome.startZoneTerrainSurvey.road': 'Дорога 4 x 12',
  'hudChrome.startZoneTerrainSurvey.minimumHeight': 'Минимальная высота: {value} м',
  'hudChrome.startZoneTerrainSurvey.maximumHeight': 'Максимальная высота: {value} м',
  'hudChrome.startZoneTerrainSurvey.averageSlope': 'Средний уклон: {value} градусов',
  'hudChrome.startZoneTerrainSurvey.maximumSlope': 'Максимальный уклон: {value} градусов',
  'hudChrome.startZoneTerrainSurvey.flatSurface': 'Ровный рельеф: {value}%',
  'hudChrome.startZoneTerrainSurvey.compatibleSurfaces': 'Подходящие участки: {count}',
  'hudChrome.startZoneTerrainSurvey.anchorsCount': 'Сохранённые точки: {count}',
  'hudChrome.startZoneTerrainSurvey.verdict': 'Вердикт под курсором: {verdict}',
  'hudChrome.startZoneTerrainSurvey.compatible': 'подходит',
  'hudChrome.startZoneTerrainSurvey.incompatible': 'не подходит',
  'hudChrome.startZoneTerrainSurvey.noTerrain': 'вне исследованного рельефа',
  'hudChrome.startZoneTerrainSurvey.cornerDifference': '{corner}: {value} м',
  'hudChrome.startZoneTerrainSurvey.anchorName': 'Название опорной точки',
  'hudChrome.startZoneTerrainSurvey.anchorNameDefault': 'Точка исследования',
  'hudChrome.startZoneTerrainSurvey.proposedType': 'Предлагаемый тип',
  'hudChrome.startZoneTerrainSurvey.notes': 'Примечания',
  'hudChrome.startZoneTerrainSurvey.saveAnchor': 'Сохранить опорную точку',
  'hudChrome.startZoneTerrainSurvey.clearAnchors': 'Очистить опорные точки',
  'hudChrome.startZoneTerrainSurvey.exportReport': 'Экспортировать отчёт JSON',
  'hudChrome.startZoneTerrainSurvey.typeBuildingSmall': 'Малое здание',
  'hudChrome.startZoneTerrainSurvey.typeBuildingMedium': 'Среднее здание',
  'hudChrome.startZoneTerrainSurvey.typeBuildingLarge': 'Большое здание',
  'hudChrome.startZoneTerrainSurvey.typePlaza': 'Площадь',
  'hudChrome.startZoneTerrainSurvey.typeRoad': 'Дорога',
  'hudChrome.startZoneTerrainSurvey.typeDecorative': 'Декоративный объект',
  'hudChrome.startZoneTerrainSurvey.typeAvoid': 'Избегать',
  'hudChrome.startZoneTerrainSurvey.statusAnchorSaved': 'Опорная точка сохранена локально',
  'hudChrome.startZoneTerrainSurvey.statusAnchorRejected': 'Не удалось сохранить опорную точку',
  'hudChrome.startZoneTerrainSurvey.statusAnchorsCleared': 'Локальные опорные точки очищены',
  ...
  'seo.officialLabel': 'Официальный сайт World of CodexCraft',
  'seo.officialBody':
  ...
  'playerCard.defaultRealm': 'Мир CodexCraft',
  ...
  'playerCard.shareText':
    'Я создаю свою легенду в World of CodexCraft: уровень {level}, {className}{tierBit}. Присоединяйтесь к моему миру:',
  'playerCard.nativeShareTitle': 'Мир CodexCraft',
  ...
  'seo.title': 'World of CodexCraft: веб-MMO в классическом стиле',
  'seo.description':
    'Отправьтесь в эпическое приключение в World of CodexCraft, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к постоянному общему миру, развивайте классы и побеждайте врагов.',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'Открыть проект World of CodexCraft на GitHub',
  'a11y.discordCommunity': 'Присоединиться к Discord-сообществу World of CodexCraft',
  'a11y.donateProject': 'Пожертвовать на поддержку World of CodexCraft',
  ...
  'mobilePreflight.iosOpenStep':
    'Откройте World of CodexCraft через новый значок на домашнем экране.',
  ...
  'mobilePreflight.androidOpenStep': 'Откройте World of CodexCraft через новый значок.',
  ...
  'serverUnavailable.title': 'World of CodexCraft - мир недоступен',
  ...
  'mode.play': 'Играть',
  'mode.playAria': 'Играть в World of CodexCraft',
  ...
  'guide.worldPage.intro':
    'World of CodexCraft - это единый цельный край, который вы пересекаете пешком, три зоны, протянувшиеся с юга на север. Здесь нет быстрых перемещений, так что дорога - это часть приключения.',
  ...
  'hudChrome.nativeUpdate.body':
    'Доступна новая версия World of CodexCraft. Обновите сейчас, чтобы получить последние исправления и улучшения.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Доступна версия {version} World of CodexCraft. Обновите сейчас, чтобы получить последние исправления и улучшения.',
  ...
  'desktop.crash.fatalBody':
    'World of CodexCraft столкнулась с непредвиденной ошибкой и будет закрыта.',
  'editor.appTitle': 'Редактор карт',
  'editor.docTitle': 'Редактор карт - World of CodexCraft',
