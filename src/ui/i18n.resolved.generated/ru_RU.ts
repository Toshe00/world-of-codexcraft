...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    "naturePlacementLab": {
      ...
      "assetsSection": "Объекты",
      "projectsSection": "Проекты",
      "layersSection": "Слои",
      "groupsSection": "Группы",
      "statisticsSection": "Статистика",
      "selectionSection": "Выбор",
      "transformSection": "Преобразование",
      "snappingSection": "Привязка",
      "historySection": "История",
      "importExportSection": "Импорт и экспорт",
      ...
      "confirmDeleteProject": "Удалить текущий локальный проект?",
      "untitledProjectName": "Проект без названия",
      "importedProjectName": "Импортированные объекты",
      "createLayer": "Создать слой",
      "renameLayer": "Переименовать слой",
      "deleteLayer": "Удалить слой",
      "deleteLayerPlacements": "Удалить объекты слоя",
      ...
      "confirmDeleteLayer": "Удалить этот пустой слой?",
      "confirmDeleteLayerPlacements": "Удалить все объекты этого слоя?",
      "visible": "Видимый",
      "locked": "Заблокирован",
      ...
      "selectByAsset": "Выбрать по объекту",
      "moveToLayer": "Переместить в слой",
      "selectedCount": "Выбрано: {count}",
      "selectedAssets": "Объекты: {assets}",
      "selectedLayers": "Слои: {layers}",
      "groupSelection": "Сгруппировать выбранное",
      "ungroup": "Разгруппировать",
      "renameGroup": "Переименовать группу",
      "selectGroup": "Выбрать группу",
      "duplicateGroup": "Дублировать группу",
      "deleteGroup": "Удалить группу",
      "deleteGroupAndPlacements": "Удалить группу и объекты",
      "groupNamePrompt": "Название группы",
      "confirmDeleteGroupPlacements": "Удалить эту группу и все её объекты?",
      "groupCopyName": "Копия {name}",
      "groupSummary": "{name} ({count})",
      "applyGroupTransform": "Применить преобразование группы",
      "selectionCenterX": "Центр выбора X",
      "selectionCenterY": "Центр выбора Y",
      "selectionCenterZ": "Центр выбора Z",
      "rotationDelta": "Изменение поворота",
      "scaleFactor": "Коэффициент масштаба",
      "groundOffsetDelta": "Изменение смещения от земли",
      "totalPlacements": "Всего объектов: {count}",
      "visiblePlacements": "Видимых объектов: {count}",
      "statisticsSelected": "Выбрано: {count}",
      "placementsByAsset": "По объектам: {counts}",
      "placementsByLayer": "По слоям: {counts}",
      "estimatedTriangles": "Оценка треугольников: {count}",
      "estimatedMediaBytes": "Оценка размера медиа: {count}",
      ...
      "apply": "Применить",
      "resetTransform": "Сбросить преобразование",
      "placeOnGround": "Поставить на землю",
      ...
      "positionY": "Позиция Y",
      "positionZ": "Позиция Z",
      "rotationYDegrees": "Поворот Y (градусы)",
      "scale": "Масштаб",
      "groundOffsetY": "Смещение Y от земли",
      "showGrid": "Показать сетку",
      "hideGrid": "Скрыть сетку",
      "gridSize": "Размер ячейки сетки",
      "snapPosition": "Привязка позиции",
      "snapRotation": "Привязка поворота",
      "snapScale": "Привязка масштаба",
      "snapToGround": "Привязка к земле",
      ...
      "historyState": "Отмена: {undo}. Повтор: {redo}.",
      ...
      "help": "Ctrl+Z/Y отменяет и повторяет. Ctrl+D дублирует. G включает сетку. X включает привязку позиции. T ставит на землю. R вращает. Колесо или плюс и минус меняют масштаб. Page Up и Page Down меняют высоту.",
      "statusReady": "Готово",
      ...
      "statusNothingToUndo": "Нечего отменять",
      "statusNothingToRedo": "Нечего повторять",
      "statusUndone": "Последнее изменение отменено",
      "statusRedone": "Последнее изменение восстановлено",
      "statusDuplicateFailed": "Не удалось дублировать выбранный объект",
      "statusDuplicated": "{id} дублирован и выбран",
      "statusTransformRejected": "Преобразование отклонено",
      "statusTransformApplied": "Преобразование применено",
      "statusTransformReset": "Преобразование сброшено к значениям объекта",
      "statusPlacedOnGround": "Объект выровнен по существующему рельефу",
      "statusPreferencesSaved": "Настройки редактора обновлены",
      "statusFiniteRequired": "{field}: требуется конечное число",
      "statusOutsideLimits": "{field}: значение должно быть от {min} до {max}",
      "statusLockedLayer": "Слой заблокирован",
      "statusOperationRejected": "Операция отклонена",
      "statusProjectCreated": "Проект создан",
      "statusProjectRenamed": "Проект переименован",
      "statusProjectSaved": "Проект сохранён",
      "statusProjectLoaded": "Проект загружен",
      "statusProjectDeleted": "Проект удалён",
      "statusProjectFailed": "Операция с проектом не выполнена",
      "statusLayerCreated": "Слой создан",
      "statusLayerRenamed": "Слой переименован",
      "statusLayerDeleted": "Слой удалён",
      "statusLayerCleared": "Слой очищен",
      "statusLayerUpdated": "Слой обновлён",
      "statusLayerChanged": "Слой изменён",
      "statusGroupCreated": "Группа создана",
      "statusGroupRenamed": "Группа переименована",
      "statusGroupDuplicated": "Группа дублирована",
      "statusGroupDeleted": "Группа удалена"
    },
    "startZoneTerrainSurvey": {
      "title": "Исследование рельефа стартовой зоны",
      "terrainSection": "Анализ рельефа",
      "footprintSection": "Пятно застройки",
      "anchorSection": "Опорные точки",
      "resolution": "Разрешение сетки",
      "selectedTemplate": "Шаблон здания",
      "rotation": "Поворот по оси Y",
      "showGrid": "Показать сетку",
      "hideGrid": "Скрыть сетку",
      "smallHouse": "Малый дом 6 x 6",
      "mediumHouse": "Средний дом 10 x 8",
      "largeHouse": "Большой дом 14 x 12",
      "centralPlaza": "Центральная площадь 20 x 20",
      "road": "Дорога 4 x 12",
      "minimumHeight": "Минимальная высота: {value} м",
      "maximumHeight": "Максимальная высота: {value} м",
      "averageSlope": "Средний уклон: {value} градусов",
      "maximumSlope": "Максимальный уклон: {value} градусов",
      "flatSurface": "Ровный рельеф: {value}%",
      "compatibleSurfaces": "Подходящие участки: {count}",
      "anchorsCount": "Сохранённые точки: {count}",
      "verdict": "Вердикт под курсором: {verdict}",
      "compatible": "подходит",
      "incompatible": "не подходит",
      "noTerrain": "вне исследованного рельефа",
      "cornerDifference": "{corner}: {value} м",
      "anchorName": "Название опорной точки",
      "anchorNameDefault": "Точка исследования",
      "proposedType": "Предлагаемый тип",
      "notes": "Примечания",
      "saveAnchor": "Сохранить опорную точку",
      "clearAnchors": "Очистить опорные точки",
      "exportReport": "Экспортировать отчёт JSON",
      "typeBuildingSmall": "Малое здание",
      "typeBuildingMedium": "Среднее здание",
      "typeBuildingLarge": "Большое здание",
      "typePlaza": "Площадь",
      "typeRoad": "Дорога",
      "typeDecorative": "Декоративный объект",
      "typeAvoid": "Избегать",
      "statusAnchorSaved": "Опорная точка сохранена локально",
      "statusAnchorRejected": "Не удалось сохранить опорную точку",
      "statusAnchorsCleared": "Локальные опорные точки очищены"
    },
    ...
    "nativeUpdate": {
      ...
      "body": "Доступна новая версия World of CodexCraft. Обновите сейчас, чтобы получить последние исправления и улучшения.",
      "bodyWithVersion": "Доступна версия {version} World of CodexCraft. Обновите сейчас, чтобы получить последние исправления и улучшения.",
      "notNow": "Не сейчас",
      "update": "Обновить"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Мир",
      "intro": "World of CodexCraft - это единый цельный край, который вы пересекаете пешком, три зоны, протянувшиеся с юга на север. Здесь нет быстрых перемещений, так что дорога - это часть приключения.",
      "hub": "Опорная база",
  ...
  "editor": {
    ...
    "docTitle": "Редактор карт - World of CodexCraft",
  ...
  "mode": {
    ...
    "play": "Играть",
    "playAria": "Играть в World of CodexCraft",
  ...
  "playerCard": {
    ...
    "shareText": "Я создаю свою легенду в World of CodexCraft: уровень {level}, {className}{tierBit}. Присоединяйтесь к моему миру:",
    "nativeShareTitle": "Мир CodexCraft",
  ...
  "seo": {
    "title": "World of CodexCraft: веб-MMO в классическом стиле",
    "description": "Отправьтесь в эпическое приключение в World of CodexCraft, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к постоянному общему миру, развивайте классы и побеждайте врагов.",
    "genre": "MMORPG",
    "playMode": "Многопользовательская игра",
    "applicationCategory": "Игра",
    "operatingSystem": "Веб-браузер",
    "officialLabel": "Официальный сайт World of CodexCraft",
  ...
  "a11y": {
    ...
    "githubProject": "Открыть проект World of CodexCraft на GitHub",
    "discordCommunity": "Присоединиться к Discord-сообществу World of CodexCraft",
    "donateProject": "Пожертвовать на поддержку World of CodexCraft"
  },
  "loading": {
    "world": "Загрузка мира...",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "quit": "Выйти",
      "fatalBody": "World of CodexCraft столкнулась с непредвиденной ошибкой и будет закрыта."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Откройте World of CodexCraft через новый значок на домашнем экране.",
    ...
    "androidOpenStep": "Откройте World of CodexCraft через новый значок.",
  ...
  "serverUnavailable": {
    "title": "World of CodexCraft - мир недоступен",
