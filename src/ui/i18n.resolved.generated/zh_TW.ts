...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    "naturePlacementLab": {
      ...
      "loadProject": "載入專案",
      "deleteProject": "刪除專案",
      "projectNamePrompt": "專案名稱",
      "confirmDeleteProject": "刪除目前的本機專案？",
      "untitledProjectName": "未命名專案",
      "importedProjectName": "匯入的配置專案",
      "createLayer": "建立圖層",
      "renameLayer": "重新命名圖層",
      "deleteLayer": "刪除圖層",
      "deleteLayerPlacements": "刪除圖層物件",
      "layerNamePrompt": "圖層名稱",
      ...
      "confirmDeleteLayer": "刪除此空圖層？",
      "confirmDeleteLayerPlacements": "刪除此圖層的所有物件？",
      "visible": "可見",
      "locked": "已鎖定",
      "selectLayer": "選取圖層",
      "selectAll": "全選",
      ...
      "selectedAssets": "資源：{assets}",
      "selectedLayers": "圖層：{layers}",
      "groupSelection": "群組選取項目",
      "ungroup": "取消群組",
      "renameGroup": "重新命名群組",
      "selectGroup": "選取群組",
      "duplicateGroup": "複製群組",
      "deleteGroup": "刪除群組",
      "deleteGroupAndPlacements": "刪除群組及物件",
      "groupNamePrompt": "群組名稱",
      "confirmDeleteGroupPlacements": "刪除此群組及其所有物件？",
      "groupCopyName": "{name} 副本",
      "groupSummary": "{name}（{count}）",
      "applyGroupTransform": "套用群組變換",
      "selectionCenterX": "選取中心 X",
      "selectionCenterY": "選取中心 Y",
      "selectionCenterZ": "選取中心 Z",
      "rotationDelta": "旋轉增量",
      "scaleFactor": "縮放倍率",
      "groundOffsetDelta": "地面偏移增量",
      "totalPlacements": "物件總數：{count}",
      "visiblePlacements": "可見物件：{count}",
      "statisticsSelected": "已選取：{count}",
      "placementsByAsset": "依資源：{counts}",
      "placementsByLayer": "依圖層：{counts}",
      "estimatedTriangles": "估計三角形：{count}",
      "estimatedMediaBytes": "估計媒體大小：{count}",
      "assetsAria": "實驗室資源",
      "placeSelected": "放置所選資源",
      ...
      "positionY": "位置 Y",
      "positionZ": "位置 Z",
      "rotationYDegrees": "Y 軸旋轉（度）",
      "scale": "縮放",
      "groundOffsetY": "地面 Y 偏移",
      "showGrid": "顯示網格",
      "hideGrid": "隱藏網格",
      "gridSize": "網格單元大小",
      "snapPosition": "位置吸附",
      ...
      "available": "可用",
      "unavailable": "不可用",
      "historyState": "復原：{undo}。重做：{redo}。",
      "selectedObject": "所選物件：{id}",
      "selectedAsset": "所選資源：{assetId}",
      "noAssetSelected": "未選擇資源",
      "cancelPlacement": "取消放置",
      "placementsCount": "實驗室放置數：{count}",
      "help": "Ctrl+Z/Y 復原和重做。Ctrl+D 複製。G 切換網格。X 切換位置吸附。T 放置到地面。R 旋轉。滾輪或加減鍵縮放。Page Up 和 Page Down 調整高度。",
      "statusReady": "就緒",
      "statusAssetSelected": "已選擇 {assetId}",
      "statusSelectAssetFirst": "請先選擇資源",
      "statusPlacementActive": "放置模式已啟用",
      "statusPlacementCancelled": "已取消放置",
      "statusPlacementMoved": "物件已移動",
      "statusNoTerrain": "沒有有效的地形點",
      "statusAssetPlaced": "已放置 {assetId}",
      "statusPlacementSelected": "已選擇 {id}",
      "statusNoSelection": "未選擇放置物件",
      "statusPlacementDeleted": "放置物件已刪除",
      "statusCleared": "已清除所有實驗室放置物件",
      "statusExported": "已匯出 {count} 個放置物件",
      "statusImported": "已匯入 {count} 個放置物件",
      "statusImportFailed": "放置資料匯入失敗",
      ...
      "statusTransformAdjusted": "變換已調整",
      "statusNothingToUndo": "沒有可復原的操作",
      "statusNothingToRedo": "沒有可重做的操作",
      "statusUndone": "已復原上次編輯",
      "statusRedone": "已恢復上次編輯",
      "statusDuplicateFailed": "無法複製所選放置物件",
      "statusDuplicated": "已複製並選擇 {id}",
      "statusTransformRejected": "變換被拒絕",
      "statusTransformApplied": "變換已套用",
      "statusTransformReset": "變換已重設為資源預設值",
      "statusPlacedOnGround": "放置物件已對齊現有地形",
      "statusPreferencesSaved": "編輯器選項已更新",
      "statusFiniteRequired": "{field} 必須是有限數字",
      "statusOutsideLimits": "{field} 必須介於 {min} 和 {max} 之間",
      "statusLockedLayer": "圖層已鎖定",
      "statusOperationRejected": "操作遭拒",
      "statusProjectCreated": "專案已建立",
      "statusProjectRenamed": "專案已重新命名",
      "statusProjectSaved": "專案已儲存",
      "statusProjectLoaded": "專案已載入",
      "statusProjectDeleted": "專案已刪除",
      "statusProjectFailed": "專案操作失敗",
      "statusLayerCreated": "圖層已建立",
      "statusLayerRenamed": "圖層已重新命名",
      "statusLayerDeleted": "圖層已刪除",
      "statusLayerCleared": "圖層已清空",
      "statusLayerUpdated": "圖層已更新",
      "statusLayerChanged": "圖層已變更",
      "statusGroupCreated": "群組已建立",
      "statusGroupRenamed": "群組已重新命名",
      "statusGroupDuplicated": "群組已複製",
      "statusGroupDeleted": "群組已刪除"
    },
    "startZoneTerrainSurvey": {
      "title": "起始區域地形勘測",
      "terrainSection": "地形分析",
      "footprintSection": "建築占地",
      "anchorSection": "錨點",
      "resolution": "網格解析度",
      "selectedTemplate": "建築範本",
      "rotation": "Y 軸旋轉",
      "showGrid": "顯示網格",
      "hideGrid": "隱藏網格",
      "smallHouse": "小型房屋 6 x 6",
      "mediumHouse": "中型房屋 10 x 8",
      "largeHouse": "大型房屋 14 x 12",
      "centralPlaza": "中央廣場 20 x 20",
      "road": "道路 4 x 12",
      "minimumHeight": "最低高度：{value} 公尺",
      "maximumHeight": "最高高度：{value} 公尺",
      "averageSlope": "平均坡度：{value} 度",
      "maximumSlope": "最大坡度：{value} 度",
      "flatSurface": "平坦地形：{value}%",
      "compatibleSurfaces": "相容區域：{count}",
      "anchorsCount": "已儲存錨點：{count}",
      "verdict": "游標位置判定：{verdict}",
      "compatible": "相容",
      "incompatible": "不相容",
      "noTerrain": "在勘測地形範圍之外",
      "cornerDifference": "{corner}：{value} 公尺",
      "anchorName": "錨點名稱",
      "anchorNameDefault": "勘測錨點",
      "proposedType": "建議類型",
      "notes": "備註",
      "saveAnchor": "儲存錨點",
      "clearAnchors": "清除錨點",
      "exportReport": "匯出 JSON 報告",
      "typeBuildingSmall": "小型建築",
      "typeBuildingMedium": "中型建築",
      "typeBuildingLarge": "大型建築",
      "typePlaza": "廣場",
      "typeRoad": "道路",
      "typeDecorative": "裝飾",
      "typeAvoid": "避開",
      "statusAnchorSaved": "錨點已儲存在本機",
      "statusAnchorRejected": "無法儲存錨點",
      "statusAnchorsCleared": "本機錨點已清除"
    },
    ...
    "nativeUpdate": {
      "title": "有可用更新",
      "body": "World of CodexCraft 有新版本可用。立即更新以取得最新修正與改進。",
      "bodyWithVersion": "World of CodexCraft {version} 版本已可用。立即更新以取得最新修正與改進。",
      "notNow": "暫不",
      "update": "更新"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "World of CodexCraft 是一片你需徒步橫越的連綿大地，三大區域由南向北排列。沒有快速旅行，所以旅程本身就是冒險的一部分。",
      "hub": "主據點",
      "mapHeading": "北行之路",
  ...
  "editor": {
    "appTitle": "地圖編輯器",
    "docTitle": "地圖編輯器 - World of CodexCraft",
    "untitledMap": "未命名地圖",
  ...
  "mode": {
    ...
    "serverOffline": "離線",
    "play": "開始遊戲",
    "playAria": "遊玩 World of CodexCraft",
    "serverLabel": "選擇你的世界",
  ...
  "playerCard": {
    ...
    "shareText": "我正在 World of CodexCraft 中鑄就傳說：{level}級 {className}{tierBit}。加入我的世界：",
  ...
  "seo": {
    "title": "World of CodexCraft：經典風格網頁 MMO",
    "description": "在 World of CodexCraft 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的世界，提升職業等級並擊敗敵人！",
    "genre": "MMORPG",
    "playMode": "多人遊戲",
    "applicationCategory": "遊戲",
    "operatingSystem": "網頁瀏覽器",
    "officialLabel": "World of CodexCraft 官方網站",
  ...
  "a11y": {
    ...
    "githubProject": "開啟 World of CodexCraft 的 GitHub 專案",
    "discordCommunity": "加入 World of CodexCraft 的 Discord 社群",
    "donateProject": "捐贈支持 World of CodexCraft"
  },
  "loading": {
    "world": "正在載入世界...",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "重新載入",
      "quit": "離開",
      "fatalBody": "World of CodexCraft 發生未預期的錯誤，必須關閉。"
    }
  },
  "realm": {
    "noRealms": "沒有可用的世界。",
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "從新的主畫面圖示開啟 World of CodexCraft。",
