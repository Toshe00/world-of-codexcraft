...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  'hudChrome.naturePlacementLab.untitledProjectName': '名称未設定プロジェクト',
  'hudChrome.naturePlacementLab.importedProjectName': 'インポートした配置',
  'hudChrome.naturePlacementLab.groupCopyName': '{name} のコピー',
  'hudChrome.naturePlacementLab.groupSummary': '{name}（{count}）',
  'hudChrome.naturePlacementLab.projectsSection': 'プロジェクト',
  'hudChrome.naturePlacementLab.layersSection': 'レイヤー',
  'hudChrome.naturePlacementLab.groupsSection': 'グループ',
  'hudChrome.naturePlacementLab.statisticsSection': '統計',
  'hudChrome.naturePlacementLab.newProject': '新規プロジェクト',
  'hudChrome.naturePlacementLab.renameProject': 'プロジェクト名を変更',
  'hudChrome.naturePlacementLab.saveProject': 'プロジェクトを保存',
  'hudChrome.naturePlacementLab.saveProjectAs': '名前を付けて保存',
  'hudChrome.naturePlacementLab.loadProject': 'プロジェクトを読み込み',
  'hudChrome.naturePlacementLab.deleteProject': 'プロジェクトを削除',
  'hudChrome.naturePlacementLab.projectNamePrompt': 'プロジェクト名',
  'hudChrome.naturePlacementLab.confirmDeleteProject': '現在のローカルプロジェクトを削除しますか？',
  'hudChrome.naturePlacementLab.createLayer': 'レイヤーを作成',
  'hudChrome.naturePlacementLab.renameLayer': 'レイヤー名を変更',
  'hudChrome.naturePlacementLab.deleteLayer': 'レイヤーを削除',
  'hudChrome.naturePlacementLab.deleteLayerPlacements': 'レイヤーの配置を削除',
  'hudChrome.naturePlacementLab.layerNamePrompt': 'レイヤー名',
  'hudChrome.naturePlacementLab.confirmDeleteLayer': 'この空のレイヤーを削除しますか？',
  'hudChrome.naturePlacementLab.confirmDeleteLayerPlacements':
    'このレイヤーの配置をすべて削除しますか？',
  'hudChrome.naturePlacementLab.visible': '表示',
  'hudChrome.naturePlacementLab.locked': 'ロック済み',
  'hudChrome.naturePlacementLab.selectLayer': 'レイヤーを選択',
  'hudChrome.naturePlacementLab.selectAll': 'すべて選択',
  'hudChrome.naturePlacementLab.deselectAll': '選択を解除',
  'hudChrome.naturePlacementLab.invertSelection': '選択を反転',
  'hudChrome.naturePlacementLab.selectByAsset': 'アセット別に選択',
  'hudChrome.naturePlacementLab.moveToLayer': 'レイヤーへ移動',
  'hudChrome.naturePlacementLab.selectedCount': '選択済み：{count}',
  'hudChrome.naturePlacementLab.selectedAssets': 'アセット：{assets}',
  'hudChrome.naturePlacementLab.selectedLayers': 'レイヤー：{layers}',
  'hudChrome.naturePlacementLab.groupSelection': '選択をグループ化',
  'hudChrome.naturePlacementLab.ungroup': 'グループ解除',
  'hudChrome.naturePlacementLab.renameGroup': 'グループ名を変更',
  'hudChrome.naturePlacementLab.selectGroup': 'グループを選択',
  'hudChrome.naturePlacementLab.duplicateGroup': 'グループを複製',
  'hudChrome.naturePlacementLab.deleteGroup': 'グループを削除',
  'hudChrome.naturePlacementLab.deleteGroupAndPlacements': 'グループと配置を削除',
  'hudChrome.naturePlacementLab.groupNamePrompt': 'グループ名',
  'hudChrome.naturePlacementLab.confirmDeleteGroupPlacements':
    'このグループとすべての配置を削除しますか？',
  'hudChrome.naturePlacementLab.applyGroupTransform': 'グループ変換を適用',
  'hudChrome.naturePlacementLab.selectionCenterX': '選択中心 X',
  'hudChrome.naturePlacementLab.selectionCenterY': '選択中心 Y',
  'hudChrome.naturePlacementLab.selectionCenterZ': '選択中心 Z',
  'hudChrome.naturePlacementLab.rotationDelta': '回転差分',
  'hudChrome.naturePlacementLab.scaleFactor': 'スケール倍率',
  'hudChrome.naturePlacementLab.groundOffsetDelta': '地面オフセット差分',
  'hudChrome.naturePlacementLab.totalPlacements': '配置総数：{count}',
  'hudChrome.naturePlacementLab.visiblePlacements': '表示中：{count}',
  'hudChrome.naturePlacementLab.statisticsSelected': '選択済み：{count}',
  'hudChrome.naturePlacementLab.placementsByAsset': 'アセット別：{counts}',
  'hudChrome.naturePlacementLab.placementsByLayer': 'レイヤー別：{counts}',
  'hudChrome.naturePlacementLab.estimatedTriangles': '推定三角形数：{count}',
  'hudChrome.naturePlacementLab.estimatedMediaBytes': '推定メディアサイズ：{count}',
  'hudChrome.naturePlacementLab.statusLockedLayer': 'レイヤーはロックされています',
  'hudChrome.naturePlacementLab.statusOperationRejected': '操作は拒否されました',
  'hudChrome.naturePlacementLab.statusProjectCreated': 'プロジェクトを作成しました',
  'hudChrome.naturePlacementLab.statusProjectRenamed': 'プロジェクト名を変更しました',
  'hudChrome.naturePlacementLab.statusProjectSaved': 'プロジェクトを保存しました',
  'hudChrome.naturePlacementLab.statusProjectLoaded': 'プロジェクトを読み込みました',
  'hudChrome.naturePlacementLab.statusProjectDeleted': 'プロジェクトを削除しました',
  'hudChrome.naturePlacementLab.statusProjectFailed': 'プロジェクト操作に失敗しました',
  'hudChrome.naturePlacementLab.statusLayerCreated': 'レイヤーを作成しました',
  'hudChrome.naturePlacementLab.statusLayerRenamed': 'レイヤー名を変更しました',
  'hudChrome.naturePlacementLab.statusLayerDeleted': 'レイヤーを削除しました',
  'hudChrome.naturePlacementLab.statusLayerCleared': 'レイヤーを空にしました',
  'hudChrome.naturePlacementLab.statusLayerUpdated': 'レイヤーを更新しました',
  'hudChrome.naturePlacementLab.statusLayerChanged': 'レイヤーを変更しました',
  'hudChrome.naturePlacementLab.statusGroupCreated': 'グループを作成しました',
  'hudChrome.naturePlacementLab.statusGroupRenamed': 'グループ名を変更しました',
  'hudChrome.naturePlacementLab.statusGroupDuplicated': 'グループを複製しました',
  'hudChrome.naturePlacementLab.statusGroupDeleted': 'グループを削除しました',
  'hudChrome.naturePlacementLab.title': '自然配置ラボ',
  'hudChrome.naturePlacementLab.assetsSection': 'アセット',
  'hudChrome.naturePlacementLab.selectionSection': '選択',
  'hudChrome.naturePlacementLab.transformSection': '変換',
  'hudChrome.naturePlacementLab.snappingSection': 'スナップ',
  'hudChrome.naturePlacementLab.historySection': '履歴',
  'hudChrome.naturePlacementLab.importExportSection': 'インポートとエクスポート',
  'hudChrome.naturePlacementLab.apply': '適用',
  'hudChrome.naturePlacementLab.resetTransform': '変換をリセット',
  'hudChrome.naturePlacementLab.placeOnGround': '地面に配置',
  'hudChrome.naturePlacementLab.duplicate': '複製',
  'hudChrome.naturePlacementLab.id': 'ID',
  'hudChrome.naturePlacementLab.assetId': 'アセット ID',
  'hudChrome.naturePlacementLab.positionX': '位置 X',
  'hudChrome.naturePlacementLab.positionY': '位置 Y',
  'hudChrome.naturePlacementLab.positionZ': '位置 Z',
  'hudChrome.naturePlacementLab.rotationYDegrees': 'Y 回転（度）',
  'hudChrome.naturePlacementLab.scale': 'スケール',
  'hudChrome.naturePlacementLab.groundOffsetY': '地面 Y オフセット',
  'hudChrome.naturePlacementLab.showGrid': 'グリッドを表示',
  'hudChrome.naturePlacementLab.hideGrid': 'グリッドを非表示',
  'hudChrome.naturePlacementLab.gridSize': 'グリッドセルサイズ',
  'hudChrome.naturePlacementLab.snapPosition': '位置をスナップ',
  'hudChrome.naturePlacementLab.snapRotation': '回転をスナップ',
  'hudChrome.naturePlacementLab.snapScale': 'スケールをスナップ',
  'hudChrome.naturePlacementLab.snapToGround': '地面にスナップ',
  'hudChrome.naturePlacementLab.rotationStep': '回転ステップ（度）',
  'hudChrome.naturePlacementLab.scaleStep': 'スケールステップ',
  'hudChrome.naturePlacementLab.undo': '元に戻す',
  'hudChrome.naturePlacementLab.redo': 'やり直す',
  'hudChrome.naturePlacementLab.available': '使用可能',
  'hudChrome.naturePlacementLab.unavailable': '使用不可',
  'hudChrome.naturePlacementLab.historyState': '元に戻す：{undo}。やり直す：{redo}。',
  'hudChrome.naturePlacementLab.assetsAria': 'ラボ用アセット',
  'hudChrome.naturePlacementLab.placeSelected': '選択アセットを配置',
  'hudChrome.naturePlacementLab.deleteSelected': '選択オブジェクトを削除',
  'hudChrome.naturePlacementLab.clearAll': 'すべて消去',
  'hudChrome.naturePlacementLab.exportJson': 'JSON をエクスポート',
  'hudChrome.naturePlacementLab.importJson': 'JSON をインポート',
  'hudChrome.naturePlacementLab.selectedObject': '選択中のオブジェクト：{id}',
  'hudChrome.naturePlacementLab.selectedAsset': '選択中のアセット：{assetId}',
  'hudChrome.naturePlacementLab.noAssetSelected': 'アセット未選択',
  'hudChrome.naturePlacementLab.cancelPlacement': '配置をキャンセル',
  'hudChrome.naturePlacementLab.placementsCount': 'ラボ配置数：{count}',
  'hudChrome.naturePlacementLab.help':
    'Ctrl+Z/Y で元に戻す・やり直す。Ctrl+D で複製。G でグリッド、X で位置スナップを切り替え。T で地面に配置。R で回転。ホイールまたはプラスとマイナスで拡縮。Page Up と Page Down で高さを調整。',
  'hudChrome.naturePlacementLab.statusReady': '準備完了',
  'hudChrome.naturePlacementLab.statusAssetSelected': '{assetId} を選択しました',
  'hudChrome.naturePlacementLab.statusSelectAssetFirst': '先にアセットを選択してください',
  'hudChrome.naturePlacementLab.statusPlacementActive': '配置モードが有効です',
  'hudChrome.naturePlacementLab.statusPlacementCancelled': '配置をキャンセルしました',
  'hudChrome.naturePlacementLab.statusPlacementMoved': '配置を移動しました',
  'hudChrome.naturePlacementLab.statusNoTerrain': '有効な地形点がありません',
  'hudChrome.naturePlacementLab.statusAssetPlaced': '{assetId} を配置しました',
  'hudChrome.naturePlacementLab.statusPlacementSelected': '{id} を選択しました',
  'hudChrome.naturePlacementLab.statusNoSelection': '配置が選択されていません',
  'hudChrome.naturePlacementLab.statusPlacementDeleted': '配置を削除しました',
  'hudChrome.naturePlacementLab.statusCleared': 'ラボの配置をすべて消去しました',
  'hudChrome.naturePlacementLab.statusExported': '{count} 件の配置をエクスポートしました',
  'hudChrome.naturePlacementLab.statusImported': '{count} 件の配置をインポートしました',
  'hudChrome.naturePlacementLab.statusImportFailed': '配置のインポートに失敗しました',
  'hudChrome.naturePlacementLab.statusTransformAdjusted': '変形を調整しました',
  'hudChrome.naturePlacementLab.statusNothingToUndo': '元に戻す編集はありません',
  'hudChrome.naturePlacementLab.statusNothingToRedo': 'やり直す編集はありません',
  'hudChrome.naturePlacementLab.statusUndone': '直前の編集を元に戻しました',
  'hudChrome.naturePlacementLab.statusRedone': '直前の編集を復元しました',
  'hudChrome.naturePlacementLab.statusDuplicateFailed': '選択した配置を複製できませんでした',
  'hudChrome.naturePlacementLab.statusDuplicated': '{id} を複製して選択しました',
  'hudChrome.naturePlacementLab.statusTransformRejected': '変換が拒否されました',
  'hudChrome.naturePlacementLab.statusTransformApplied': '変換を適用しました',
  'hudChrome.naturePlacementLab.statusTransformReset': '変換をアセットの既定値に戻しました',
  'hudChrome.naturePlacementLab.statusPlacedOnGround': '配置を既存の地形に合わせました',
  'hudChrome.naturePlacementLab.statusPreferencesSaved': 'エディター設定を更新しました',
  'hudChrome.naturePlacementLab.statusFiniteRequired': '{field} は有限数である必要があります',
  'hudChrome.naturePlacementLab.statusOutsideLimits':
    '{field} は {min} から {max} の範囲で指定してください',
  'hudChrome.startZoneTerrainSurvey.title': '開始ゾーン地形調査',
  'hudChrome.startZoneTerrainSurvey.terrainSection': '地形分析',
  'hudChrome.startZoneTerrainSurvey.footprintSection': '建物の設置面',
  'hudChrome.startZoneTerrainSurvey.anchorSection': 'アンカーポイント',
  'hudChrome.startZoneTerrainSurvey.resolution': 'グリッド解像度',
  'hudChrome.startZoneTerrainSurvey.selectedTemplate': '建物テンプレート',
  'hudChrome.startZoneTerrainSurvey.rotation': 'Y 軸回転',
  'hudChrome.startZoneTerrainSurvey.showGrid': 'グリッドを表示',
  'hudChrome.startZoneTerrainSurvey.hideGrid': 'グリッドを非表示',
  'hudChrome.startZoneTerrainSurvey.smallHouse': '小型住宅 6 x 6',
  'hudChrome.startZoneTerrainSurvey.mediumHouse': '中型住宅 10 x 8',
  'hudChrome.startZoneTerrainSurvey.largeHouse': '大型住宅 14 x 12',
  'hudChrome.startZoneTerrainSurvey.centralPlaza': '中央広場 20 x 20',
  'hudChrome.startZoneTerrainSurvey.road': '道路 4 x 12',
  'hudChrome.startZoneTerrainSurvey.minimumHeight': '最低高度: {value} m',
  'hudChrome.startZoneTerrainSurvey.maximumHeight': '最高高度: {value} m',
  'hudChrome.startZoneTerrainSurvey.averageSlope': '平均傾斜: {value} 度',
  'hudChrome.startZoneTerrainSurvey.maximumSlope': '最大傾斜: {value} 度',
  'hudChrome.startZoneTerrainSurvey.flatSurface': '平坦な地形: {value}%',
  'hudChrome.startZoneTerrainSurvey.compatibleSurfaces': '適合エリア: {count}',
  'hudChrome.startZoneTerrainSurvey.anchorsCount': '保存済みアンカー: {count}',
  'hudChrome.startZoneTerrainSurvey.verdict': 'カーソル位置の判定: {verdict}',
  'hudChrome.startZoneTerrainSurvey.compatible': '適合',
  'hudChrome.startZoneTerrainSurvey.incompatible': '不適合',
  'hudChrome.startZoneTerrainSurvey.noTerrain': '調査対象の地形範囲外',
  'hudChrome.startZoneTerrainSurvey.cornerDifference': '{corner}: {value} m',
  'hudChrome.startZoneTerrainSurvey.anchorName': 'アンカー名',
  'hudChrome.startZoneTerrainSurvey.anchorNameDefault': '調査アンカー',
  'hudChrome.startZoneTerrainSurvey.proposedType': '提案タイプ',
  'hudChrome.startZoneTerrainSurvey.notes': 'メモ',
  'hudChrome.startZoneTerrainSurvey.saveAnchor': 'アンカーポイントを保存',
  'hudChrome.startZoneTerrainSurvey.clearAnchors': 'アンカーポイントを消去',
  'hudChrome.startZoneTerrainSurvey.exportReport': 'JSON レポートをエクスポート',
  'hudChrome.startZoneTerrainSurvey.typeBuildingSmall': '小型建物',
  'hudChrome.startZoneTerrainSurvey.typeBuildingMedium': '中型建物',
  'hudChrome.startZoneTerrainSurvey.typeBuildingLarge': '大型建物',
  'hudChrome.startZoneTerrainSurvey.typePlaza': '広場',
  'hudChrome.startZoneTerrainSurvey.typeRoad': '道路',
  'hudChrome.startZoneTerrainSurvey.typeDecorative': '装飾',
  'hudChrome.startZoneTerrainSurvey.typeAvoid': '回避',
  'hudChrome.startZoneTerrainSurvey.statusAnchorSaved': 'アンカーポイントをローカルに保存しました',
  'hudChrome.startZoneTerrainSurvey.statusAnchorRejected': 'アンカーポイントを保存できませんでした',
  'hudChrome.startZoneTerrainSurvey.statusAnchorsCleared': 'ローカルのアンカーポイントを消去しました',
  ...
  'seo.officialLabel': 'World of CodexCraft 公式サイト',
  'seo.officialBody':
  ...
  'playerCard.defaultRealm': 'CodexCraftの世界',
  ...
  'playerCard.shareText':
    'World of CodexCraftで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:',
  'playerCard.nativeShareTitle': 'CodexCraftの世界',
  ...
  'seo.title': 'World of CodexCraft: クラシック風Web MMO',
  'seo.description':
    'ブラウザで直接遊べるクラシック風マイクロMMO、World of CodexCraft で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'GitHubでWorld of CodexCraftプロジェクトを開く',
  'a11y.discordCommunity': 'World of CodexCraftのDiscordコミュニティに参加',
  'a11y.donateProject': 'World of CodexCraftを支援するために寄付',
  ...
  'mobilePreflight.iosOpenStep': '新しいホーム画面アイコンからWorld of CodexCraftを開きます。',
  ...
  'mobilePreflight.androidOpenStep': '新しいアイコンからWorld of CodexCraftを開きます。',
  ...
  'serverUnavailable.title': 'World of CodexCraft - ワールド利用不可',
  ...
  'mode.play': 'プレイ',
  'mode.playAria': 'World of CodexCraftをプレイ',
  ...
  'guide.worldPage.intro':
    'World of CodexCraftは、自らの足で歩いて渡る一続きの大地です。南から北へと3つのゾーンが連なっています。ファストトラベルはなく、その旅路こそが冒険の一部です。',
  ...
  'hudChrome.nativeUpdate.body':
    'World of CodexCraft の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'World of CodexCraft のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  ...
  'desktop.crash.fatalBody': 'World of CodexCraft で予期しないエラーが発生したため、終了します。',
  'editor.appTitle': 'マップエディター',
  'editor.docTitle': 'マップエディター - World of CodexCraft',
