...
export const fr_CA: EnTranslations = {
  ...
  "hudChrome": {
    "naturePlacementLab": {
      "title": "Laboratoire de placement naturel",
      "assetsSection": "Ressources",
      "projectsSection": "Projets",
      "layersSection": "Calques",
      "groupsSection": "Groupes",
      "statisticsSection": "Statistiques",
      "selectionSection": "Sélection",
      "transformSection": "Transformation",
      "snappingSection": "Magnétisme",
      "historySection": "Historique",
      "importExportSection": "Importation et exportation",
      "publicationPreviewSection": "Aperçu de publication",
      ...
      "projectNamePrompt": "Nom du projet",
      "confirmDeleteProject": "Supprimer le projet local actif ?",
      "untitledProjectName": "Projet sans titre",
      "importedProjectName": "Placements importés",
      "createLayer": "Créer un calque",
      "renameLayer": "Renommer le calque",
      "deleteLayer": "Supprimer le calque",
      "deleteLayerPlacements": "Supprimer les objets du calque",
      "layerNamePrompt": "Nom du calque",
      "defaultLayerTrees": "Arbres",
      "defaultLayerBushes": "Buissons",
      "defaultLayerFlowers": "Fleurs",
      "defaultLayerGrass": "Herbe",
      "defaultLayerDeadNature": "Nature morte",
      "defaultLayerOther": "Autres",
      "confirmDeleteLayer": "Supprimer ce calque vide ?",
      "confirmDeleteLayerPlacements": "Supprimer tous les objets non verrouillés de ce calque ?",
      "visible": "Visible",
      "locked": "Verrouillé",
      "selectLayer": "Sélectionner le calque",
      "selectAll": "Tout sélectionner",
      "deselectAll": "Tout désélectionner",
      "invertSelection": "Inverser la sélection",
      "selectByAsset": "Sélectionner par ressource",
      "moveToLayer": "Déplacer vers le calque",
      "selectedCount": "Objets sélectionnés : {count}",
      "selectedAssets": "Ressources sélectionnées : {assets}",
      "selectedLayers": "Calques sélectionnés : {layers}",
      ...
      "deleteGroupAndPlacements": "Supprimer le groupe et ses placements",
      "groupNamePrompt": "Nom du groupe",
      "confirmDeleteGroupPlacements": "Supprimer ce groupe et tous ses objets non verrouillés ?",
      "groupCopyName": "Copie de {name}",
      "groupSummary": "{name} ({count})",
      "applyGroupTransform": "Appliquer la transformation au groupe",
      "selectionCenterX": "Centre de la sélection en X",
      "selectionCenterY": "Centre de la sélection en Y",
      "selectionCenterZ": "Centre de la sélection en Z",
      "rotationDelta": "Delta de rotation (degrés)",
      "scaleFactor": "Facteur d'échelle relatif",
      "groundOffsetDelta": "Delta de décalage au sol",
      "totalPlacements": "Placements au total : {count}",
      "visiblePlacements": "Placements visibles : {count}",
      "statisticsSelected": "Placements sélectionnés : {count}",
      "placementsByAsset": "Par ressource : {counts}",
      "placementsByLayer": "Par calque : {counts}",
      "estimatedTriangles": "Triangles estimés : {count}",
      "estimatedMediaBytes": "Médias des ressources uniques : {count} octets",
      "assetsAria": "Ressources du laboratoire",
      "placeSelected": "Placer la ressource sélectionnée",
      "deleteSelected": "Supprimer la sélection",
      "clearAll": "Tout effacer",
      "exportJson": "Exporter le projet en JSON",
      "importJson": "Importer un projet JSON",
      "zoneId": "ID de zone",
      "visibleName": "Nom visible",
      "defaultZoneName": "Zone naturelle du laboratoire",
      "layersToPublish": "Calques à publier",
      "buildZonePackage": "Construire le paquet de zone",
      "previewCompiledZone": "Prévisualiser la zone compilée",
      "stopPreview": "Arrêter l'aperçu",
      "exportZonePackage": "Exporter le paquet de zone",
      "publishedZonePreview": "Aperçu de la zone publiée",
      "noCompiledPackage": "Aucun paquet de zone compilé",
      "packageSummary": "{name} ({zoneId})",
      "packageSource": "Projet source : {projectId}, version {version}",
      "packageLayers": "Calques inclus : {layers}",
      "packagePlacementCount": "Placements compilés : {count}",
      "packageEstimatedTriangles": "Triangles compilés : {count}",
      "packageUniqueMediaBytes": "Médias uniques : {count} octets",
      "packageBounds": "Limites : X {minX} à {maxX}, Y {minY} à {maxY}, Z {minZ} à {maxZ}",
      "packageAssets": "Ressources compilées : {assets}",
      "noPublicationWarnings": "Aucun avertissement de publication",
      "warningHiddenLayersIncluded": "{count} calques masqués sélectionnés seront inclus",
      "warningEmptyLayersIncluded": "{count} calques sélectionnés ne contiennent aucun placement",
      "warningCompiledPackageStale": "Le projet a changé depuis la compilation de ce paquet",
      "apply": "Appliquer",
      "resetTransform": "Réinitialiser la transformation",
      "placeOnGround": "Placer au sol",
      "duplicate": "Dupliquer",
      "id": "ID",
      "assetId": "ID de ressource",
      "positionX": "Position X",
      "positionY": "Position Y",
      "positionZ": "Position Z",
      "rotationYDegrees": "Rotation Y (degrés)",
      "scale": "Échelle",
      "groundOffsetY": "Décalage au sol en Y",
      "showGrid": "Afficher la grille",
      "hideGrid": "Masquer la grille",
      "gridSize": "Taille des cellules de la grille",
      "snapPosition": "Magnétisme de position",
      "snapRotation": "Magnétisme de rotation",
      "snapScale": "Magnétisme d'échelle",
      "snapToGround": "Aligner sur le sol",
      "rotationStep": "Pas de rotation (degrés)",
      "scaleStep": "Pas d'échelle",
      "undo": "Annuler",
      "redo": "Rétablir",
      "available": "disponible",
      "unavailable": "indisponible",
      "historyState": "Annuler : {undo}. Rétablir : {redo}.",
      "selectedObject": "Objet sélectionné : {id}",
      "selectedAsset": "Ressource sélectionnée : {assetId}",
      "noAssetSelected": "Aucune ressource sélectionnée",
      "cancelPlacement": "Annuler le placement",
      "placementsCount": "Placements du laboratoire : {count}",
      "help": "Ctrl+Z/Y annule et rétablit. Ctrl+D duplique. G affiche ou masque la grille. X active ou désactive le magnétisme de position. T place au sol. R fait pivoter. La molette ou les touches plus et moins modifient l’échelle. Page précédente et Page suivante ajustent la hauteur.",
      "statusReady": "Prêt",
      "statusAssetSelected": "{assetId} sélectionné",
      "statusSelectAssetFirst": "Sélectionnez d'abord une ressource",
      "statusPlacementActive": "Mode placement actif",
      "statusPlacementCancelled": "Placement annulé",
      "statusPlacementMoved": "Placement déplacé",
      "statusNoTerrain": "Aucun point de terrain valide",
      "statusAssetPlaced": "{assetId} placé",
      "statusPlacementSelected": "{id} sélectionné",
      "statusNoSelection": "Aucun placement sélectionné",
      "statusPlacementDeleted": "Placement supprimé",
      "statusCleared": "Tous les placements du laboratoire sont effacés",
      "statusExported": "{count} placements exportés",
      "statusImported": "{count} placements importés",
      "statusImportFailed": "Échec de l'importation des placements",
      "statusZonePackageBuilt": "Paquet de zone construit avec {count} placements",
      "statusZonePackageBuildFailed": "Échec de la construction du paquet de zone",
      "statusBuildZonePackageFirst": "Construisez d'abord un paquet de zone",
      "statusZonePackageExported": "Paquet de zone exporté avec {count} placements",
      "statusPreviewStopped": "Aperçu de la zone compilée arrêté",
      "statusPreviewReadOnly": "La prévisualisation de la zone publiée est en lecture seule",
      "statusPreviewUnavailable": "La prévisualisation de la zone compilée est indisponible",
      "statusStopPreviewFirst": "Arrêtez d'abord la prévisualisation de la zone compilée",
      "statusFinishEditFirst": "Terminez la modification active avant de construire ou prévisualiser",
      "statusTransformAdjusted": "Transformation ajustée",
      "statusNothingToUndo": "Aucune modification à annuler",
      "statusNothingToRedo": "Aucune modification à rétablir",
      "statusUndone": "Dernière modification annulée",
      "statusRedone": "Dernière modification rétablie",
      "statusDuplicateFailed": "Impossible de dupliquer le placement sélectionné",
      "statusDuplicated": "{id} dupliqué et sélectionné",
      "statusTransformRejected": "Transformation refusée",
      "statusTransformApplied": "Transformation appliquée",
      "statusTransformReset": "Transformation réinitialisée aux valeurs par défaut de la ressource",
      "statusPlacedOnGround": "Placement aligné sur le terrain existant",
      "statusPreferencesSaved": "Options de l'éditeur mises à jour",
      "statusFiniteRequired": "{field} doit être un nombre fini",
      "statusOutsideLimits": "{field} doit être compris entre {min} et {max}",
      "statusLockedLayer": "Un calque verrouillé empêche cette opération",
      "statusOperationRejected": "L'opération a été refusée",
      "statusProjectCreated": "Projet créé",
      "statusProjectRenamed": "Projet renommé",
      "statusProjectSaved": "Projet enregistré localement",
      "statusProjectLoaded": "Projet chargé",
      "statusProjectDeleted": "Projet supprimé",
      "statusProjectFailed": "Échec de l'opération sur le projet",
      "statusLayerCreated": "Calque créé",
      "statusLayerRenamed": "Calque renommé",
      "statusLayerDeleted": "Calque supprimé",
      "statusLayerCleared": "Objets du calque supprimés",
      "statusLayerUpdated": "État du calque mis à jour",
      "statusLayerChanged": "Sélection déplacée vers le calque",
      "statusGroupCreated": "Groupe créé",
      "statusGroupRenamed": "Groupe renommé",
      "statusGroupDuplicated": "Groupe dupliqué",
      "statusGroupDeleted": "Groupe supprimé"
    },
    "startZoneTerrainSurvey": {
      "title": "Relevé du terrain de la zone de départ",
      "terrainSection": "Analyse du terrain",
      "footprintSection": "Empreinte du bâtiment",
      "anchorSection": "Points d'ancrage",
      "resolution": "Résolution de la grille",
      "selectedTemplate": "Gabarit de bâtiment",
      "rotation": "Rotation Y",
      "showGrid": "Afficher la grille",
      "hideGrid": "Masquer la grille",
      "smallHouse": "Petite maison 6 x 6",
      "mediumHouse": "Maison moyenne 10 x 8",
      "largeHouse": "Grande maison 14 x 12",
      "centralPlaza": "Place centrale 20 x 20",
      "road": "Route 4 x 12",
      "minimumHeight": "Hauteur minimale : {value} m",
      "maximumHeight": "Hauteur maximale : {value} m",
      "averageSlope": "Pente moyenne : {value} degrés",
      "maximumSlope": "Pente maximale : {value} degrés",
      "flatSurface": "Terrain plat : {value} %",
      "compatibleSurfaces": "Surfaces compatibles : {count}",
      "anchorsCount": "Ancrages enregistrés : {count}",
      "verdict": "Verdict sous le curseur : {verdict}",
      "compatible": "compatible",
      "incompatible": "incompatible",
      "noTerrain": "hors du terrain analysé",
      "cornerDifference": "{corner} : {value} m",
      "anchorName": "Nom de l'ancrage",
      "anchorNameDefault": "Ancrage du relevé",
      "proposedType": "Type proposé",
      "notes": "Notes",
      "saveAnchor": "Enregistrer le point d'ancrage",
      "clearAnchors": "Effacer les points d'ancrage",
      "exportReport": "Exporter le rapport JSON",
      "typeBuildingSmall": "Petit bâtiment",
      "typeBuildingMedium": "Bâtiment moyen",
      "typeBuildingLarge": "Grand bâtiment",
      "typePlaza": "Place",
      "typeRoad": "Route",
      "typeDecorative": "Décoratif",
      "typeAvoid": "À éviter",
      "statusAnchorSaved": "Point d’ancrage enregistré localement",
      "statusAnchorRejected": "Le point d'ancrage n'a pas pu être enregistré",
      "statusAnchorsCleared": "Points d'ancrage locaux effacés"
    },
    "startZoneTerrainPlateau": {
      "title": "Laboratoire de plateau de la zone de départ",
      "enabled": "Afficher le plateau",
      "centerX": "Centre X",
      "centerZ": "Centre Z",
      "width": "Largeur",
      "depth": "Profondeur",
      ...
      "blendWidth": "Largeur de transition",
      "falloff": "Courbe de transition",
      "linear": "Linéaire",
      "smoothstep": "Smoothstep",
      "smootherstep": "Smootherstep",
      "averageHeight": "Utiliser la hauteur moyenne",
      "cursorHeight": "Utiliser la hauteur du curseur",
      "undo": "Annuler",
      "redo": "Rétablir",
      "reset": "Réinitialiser",
      "export": "Exporter le JSON",
      "import": "Importer le JSON",
      "importPlaceholder": "Collez un document JSON de plateau",
      "target": "Hauteur cible : {value} m",
      "minimum": "Minimum original : {value} m",
      "maximum": "Maximum original : {value} m",
      "raised": "Terrain relevé maximal : {value} m",
      "lowered": "Terrain abaissé maximal : {value} m",
      "flatArea": "Surface parfaitement plane : {value} m²",
      "transitionArea": "Surface de transition : {value} m²",
      "protectedWarning": "Zones protégées rencontrées : {count}",
      "showProtectedZones": "Afficher les zones protégées",
      "protectedZonesHelp": "Ces cercles indiquent les zones protégées autour des PNJ, marchands, points de quête et autres éléments importants."
    },
    "publishedZoneLab": {
    ...
    "nativeUpdate": {
      ...
      "body": "Une nouvelle version de World of CodexCraft est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.",
      "bodyWithVersion": "La version {version} de World of CodexCraft est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Le monde",
      "intro": "World of CodexCraft est une seule terre continue que l'on traverse à pied, trois zones disposées du sud au nord. Il n'y a pas de voyage rapide, alors le trajet fait partie de l'aventure.",
      "hub": "Camp de base",
  ...
  "editor": {
    ...
    "docTitle": "Éditeur de cartes - World of CodexCraft",
  ...
  "mode": {
    ...
    "play": "Jouer",
    "playAria": "Jouer à World of CodexCraft",
  ...
  "playerCard": {
    ...
    "defaultRealm": "Monde de CodexCraft",
    ...
    "shareText": "Je forge ma légende dans World of CodexCraft : niveau {level} {className}{tierBit}. Rejoignez mon monde :",
    "nativeShareTitle": "Monde de CodexCraft",
  ...
  "seo": {
    "title": "World of CodexCraft: MMO Web de style classique",
    "description": "Lancez-vous dans une aventure épique dans World of CodexCraft, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un monde partagé et persistant, faites monter vos classes en niveau et terrassez vos ennemis.",
    "genre": "MMORPG",
    "playMode": "Multijoueur",
    "applicationCategory": "Jeu",
    "operatingSystem": "Navigateur Web",
    "officialLabel": "Site officiel de World of CodexCraft",
  ...
  "a11y": {
    ...
    "githubProject": "Ouvrir le projet World of CodexCraft sur GitHub",
    "discordCommunity": "Rejoindre la communauté World of CodexCraft sur Discord",
    "donateProject": "Faire un don pour soutenir World of CodexCraft"
  },
  "loading": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recharger",
      "quit": "Quitter",
      "fatalBody": "World of CodexCraft a rencontré une erreur inattendue et doit se fermer."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Ouvrez World of CodexCraft depuis la nouvelle icône de l'écran d'accueil.",
    ...
    "androidOpenStep": "Ouvrez World of CodexCraft depuis la nouvelle icône.",
  ...
  "serverUnavailable": {
    "title": "World of CodexCraft - Monde indisponible",
