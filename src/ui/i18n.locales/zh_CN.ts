...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  'hudChrome.naturePlacementLab.untitledProjectName': '未命名项目',
  'hudChrome.naturePlacementLab.importedProjectName': '导入的放置项目',
  'hudChrome.naturePlacementLab.groupCopyName': '{name} 副本',
  'hudChrome.naturePlacementLab.groupSummary': '{name}（{count}）',
  'hudChrome.naturePlacementLab.title': '自然放置实验室',
  'hudChrome.naturePlacementLab.projectsSection': '项目',
  'hudChrome.naturePlacementLab.layersSection': '图层',
  'hudChrome.naturePlacementLab.groupsSection': '组',
  'hudChrome.naturePlacementLab.statisticsSection': '统计',
  'hudChrome.naturePlacementLab.newProject': '新建项目',
  'hudChrome.naturePlacementLab.renameProject': '重命名项目',
  'hudChrome.naturePlacementLab.saveProject': '保存项目',
  'hudChrome.naturePlacementLab.saveProjectAs': '项目另存为',
  'hudChrome.naturePlacementLab.loadProject': '加载项目',
  'hudChrome.naturePlacementLab.deleteProject': '删除项目',
  'hudChrome.naturePlacementLab.projectNamePrompt': '项目名称',
  'hudChrome.naturePlacementLab.confirmDeleteProject': '删除当前本地项目？',
  'hudChrome.naturePlacementLab.createLayer': '创建图层',
  'hudChrome.naturePlacementLab.renameLayer': '重命名图层',
  'hudChrome.naturePlacementLab.deleteLayer': '删除图层',
  'hudChrome.naturePlacementLab.deleteLayerPlacements': '删除图层对象',
  'hudChrome.naturePlacementLab.layerNamePrompt': '图层名称',
  'hudChrome.naturePlacementLab.confirmDeleteLayer': '删除这个空图层？',
  'hudChrome.naturePlacementLab.confirmDeleteLayerPlacements': '删除此图层中所有未锁定对象？',
  'hudChrome.naturePlacementLab.visible': '可见',
  'hudChrome.naturePlacementLab.locked': '已锁定',
  'hudChrome.naturePlacementLab.selectLayer': '选择图层',
  'hudChrome.naturePlacementLab.selectAll': '全选',
  'hudChrome.naturePlacementLab.deselectAll': '取消全选',
  'hudChrome.naturePlacementLab.invertSelection': '反向选择',
  'hudChrome.naturePlacementLab.selectByAsset': '按资源选择',
  'hudChrome.naturePlacementLab.moveToLayer': '移至图层',
  'hudChrome.naturePlacementLab.selectedCount': '已选对象：{count}',
  'hudChrome.naturePlacementLab.selectedAssets': '已选资源：{assets}',
  'hudChrome.naturePlacementLab.selectedLayers': '已选图层：{layers}',
  'hudChrome.naturePlacementLab.groupSelection': '组合所选对象',
  'hudChrome.naturePlacementLab.ungroup': '取消组合',
  'hudChrome.naturePlacementLab.renameGroup': '重命名组',
  'hudChrome.naturePlacementLab.selectGroup': '选择组',
  'hudChrome.naturePlacementLab.duplicateGroup': '复制组',
  'hudChrome.naturePlacementLab.deleteGroup': '删除组',
  'hudChrome.naturePlacementLab.deleteGroupAndPlacements': '删除组及对象',
  'hudChrome.naturePlacementLab.groupNamePrompt': '组名称',
  'hudChrome.naturePlacementLab.confirmDeleteGroupPlacements': '删除此组及其中所有未锁定对象？',
  'hudChrome.naturePlacementLab.applyGroupTransform': '应用组变换',
  'hudChrome.naturePlacementLab.selectionCenterX': '选择中心 X',
  'hudChrome.naturePlacementLab.selectionCenterY': '选择中心 Y',
  'hudChrome.naturePlacementLab.selectionCenterZ': '选择中心 Z',
  'hudChrome.naturePlacementLab.rotationDelta': '旋转增量（度）',
  'hudChrome.naturePlacementLab.scaleFactor': '相对缩放系数',
  'hudChrome.naturePlacementLab.groundOffsetDelta': '地面偏移增量',
  'hudChrome.naturePlacementLab.totalPlacements': '对象总数：{count}',
  'hudChrome.naturePlacementLab.visiblePlacements': '可见对象：{count}',
  'hudChrome.naturePlacementLab.statisticsSelected': '已选对象：{count}',
  'hudChrome.naturePlacementLab.placementsByAsset': '按资源：{counts}',
  'hudChrome.naturePlacementLab.placementsByLayer': '按图层：{counts}',
  'hudChrome.naturePlacementLab.estimatedTriangles': '预计三角形：{count}',
  'hudChrome.naturePlacementLab.estimatedMediaBytes': '唯一资源媒体：{count} 字节',
  'hudChrome.naturePlacementLab.statusLockedLayer': '锁定的图层阻止了此操作',
  'hudChrome.naturePlacementLab.statusOperationRejected': '操作被拒绝',
  'hudChrome.naturePlacementLab.statusProjectCreated': '项目已创建',
  'hudChrome.naturePlacementLab.statusProjectRenamed': '项目已重命名',
  'hudChrome.naturePlacementLab.statusProjectSaved': '项目已保存到本地',
  'hudChrome.naturePlacementLab.statusProjectLoaded': '项目已加载',
  'hudChrome.naturePlacementLab.statusProjectDeleted': '项目已删除',
  'hudChrome.naturePlacementLab.statusProjectFailed': '项目操作失败',
  'hudChrome.naturePlacementLab.statusLayerCreated': '图层已创建',
  'hudChrome.naturePlacementLab.statusLayerRenamed': '图层已重命名',
  'hudChrome.naturePlacementLab.statusLayerDeleted': '图层已删除',
  'hudChrome.naturePlacementLab.statusLayerCleared': '图层对象已删除',
  'hudChrome.naturePlacementLab.statusLayerUpdated': '图层状态已更新',
  'hudChrome.naturePlacementLab.statusLayerChanged': '所选对象已移至图层',
  'hudChrome.naturePlacementLab.statusGroupCreated': '组已创建',
  'hudChrome.naturePlacementLab.statusGroupRenamed': '组已重命名',
  'hudChrome.naturePlacementLab.statusGroupDuplicated': '组已复制',
  'hudChrome.naturePlacementLab.statusGroupDeleted': '组已删除',
  'hudChrome.naturePlacementLab.assetsSection': '资源',
  'hudChrome.naturePlacementLab.selectionSection': '选择',
  'hudChrome.naturePlacementLab.transformSection': '变换',
  'hudChrome.naturePlacementLab.snappingSection': '吸附',
  'hudChrome.naturePlacementLab.historySection': '历史',
  'hudChrome.naturePlacementLab.importExportSection': '导入与导出',
  'hudChrome.naturePlacementLab.apply': '应用',
  'hudChrome.naturePlacementLab.resetTransform': '重置变换',
  'hudChrome.naturePlacementLab.placeOnGround': '放置到地面',
  'hudChrome.naturePlacementLab.duplicate': '复制',
  'hudChrome.naturePlacementLab.id': 'ID',
  'hudChrome.naturePlacementLab.assetId': '资源 ID',
  ...
  'hudChrome.naturePlacementLab.rotationYDegrees': 'Y 轴旋转（度）',
  'hudChrome.naturePlacementLab.scale': '缩放',
  'hudChrome.naturePlacementLab.groundOffsetY': '地面 Y 偏移',
  'hudChrome.naturePlacementLab.showGrid': '显示网格',
  'hudChrome.naturePlacementLab.hideGrid': '隐藏网格',
  'hudChrome.naturePlacementLab.gridSize': '网格单元大小',
  'hudChrome.naturePlacementLab.snapPosition': '位置吸附',
  'hudChrome.naturePlacementLab.snapRotation': '旋转吸附',
  'hudChrome.naturePlacementLab.snapScale': '缩放吸附',
  'hudChrome.naturePlacementLab.snapToGround': '吸附到地面',
  'hudChrome.naturePlacementLab.rotationStep': '旋转步长（度）',
  'hudChrome.naturePlacementLab.scaleStep': '缩放步长',
  'hudChrome.naturePlacementLab.undo': '撤销',
  'hudChrome.naturePlacementLab.redo': '重做',
  'hudChrome.naturePlacementLab.available': '可用',
  'hudChrome.naturePlacementLab.unavailable': '不可用',
  'hudChrome.naturePlacementLab.historyState': '撤销：{undo}。重做：{redo}。',
  'hudChrome.naturePlacementLab.assetsAria': '实验室资源',
  'hudChrome.naturePlacementLab.placeSelected': '放置所选资源',
  'hudChrome.naturePlacementLab.deleteSelected': '删除所选对象',
  'hudChrome.naturePlacementLab.clearAll': '全部清除',
  'hudChrome.naturePlacementLab.exportJson': '导出 JSON',
  'hudChrome.naturePlacementLab.importJson': '导入 JSON',
  'hudChrome.naturePlacementLab.selectedObject': '所选对象：{id}',
  'hudChrome.naturePlacementLab.selectedAsset': '所选资源：{assetId}',
  'hudChrome.naturePlacementLab.noAssetSelected': '未选择资源',
  'hudChrome.naturePlacementLab.cancelPlacement': '取消放置',
  'hudChrome.naturePlacementLab.placementsCount': '实验室放置数：{count}',
  'hudChrome.naturePlacementLab.help':
    'Ctrl+Z/Y 撤销和重做。Ctrl+D 复制。G 切换网格。X 切换位置吸附。T 放置到地面。R 旋转。滚轮或加减键缩放。Page Up 和 Page Down 调整高度。',
  'hudChrome.naturePlacementLab.statusReady': '就绪',
  'hudChrome.naturePlacementLab.statusAssetSelected': '已选择 {assetId}',
  'hudChrome.naturePlacementLab.statusSelectAssetFirst': '请先选择资源',
  'hudChrome.naturePlacementLab.statusPlacementActive': '放置模式已启用',
  'hudChrome.naturePlacementLab.statusPlacementCancelled': '已取消放置',
  'hudChrome.naturePlacementLab.statusPlacementMoved': '对象已移动',
  'hudChrome.naturePlacementLab.statusNoTerrain': '没有有效的地形点',
  'hudChrome.naturePlacementLab.statusAssetPlaced': '已放置 {assetId}',
  'hudChrome.naturePlacementLab.statusPlacementSelected': '已选择 {id}',
  'hudChrome.naturePlacementLab.statusNoSelection': '未选择放置对象',
  'hudChrome.naturePlacementLab.statusPlacementDeleted': '放置对象已删除',
  'hudChrome.naturePlacementLab.statusCleared': '已清除所有实验室放置对象',
  'hudChrome.naturePlacementLab.statusExported': '已导出 {count} 个放置对象',
  'hudChrome.naturePlacementLab.statusImported': '已导入 {count} 个放置对象',
  'hudChrome.naturePlacementLab.statusImportFailed': '放置数据导入失败',
  'hudChrome.naturePlacementLab.statusTransformAdjusted': '变换已调整',
  'hudChrome.naturePlacementLab.statusNothingToUndo': '没有可撤销的操作',
  'hudChrome.naturePlacementLab.statusNothingToRedo': '没有可重做的操作',
  'hudChrome.naturePlacementLab.statusUndone': '已撤销上次编辑',
  'hudChrome.naturePlacementLab.statusRedone': '已恢复上次编辑',
  'hudChrome.naturePlacementLab.statusDuplicateFailed': '无法复制所选放置对象',
  'hudChrome.naturePlacementLab.statusDuplicated': '已复制并选择 {id}',
  'hudChrome.naturePlacementLab.statusTransformRejected': '变换被拒绝',
  'hudChrome.naturePlacementLab.statusTransformApplied': '变换已应用',
  'hudChrome.naturePlacementLab.statusTransformReset': '变换已重置为资源默认值',
  'hudChrome.naturePlacementLab.statusPlacedOnGround': '放置对象已对齐现有地形',
  'hudChrome.naturePlacementLab.statusPreferencesSaved': '编辑器选项已更新',
  'hudChrome.naturePlacementLab.statusFiniteRequired': '{field} 必须是有限数字',
  'hudChrome.naturePlacementLab.statusOutsideLimits': '{field} 必须介于 {min} 和 {max} 之间',
  'hudChrome.startZoneTerrainSurvey.title': '起始区域地形勘测',
  'hudChrome.startZoneTerrainSurvey.terrainSection': '地形分析',
  'hudChrome.startZoneTerrainSurvey.footprintSection': '建筑占地',
  'hudChrome.startZoneTerrainSurvey.anchorSection': '锚点',
  'hudChrome.startZoneTerrainSurvey.resolution': '网格分辨率',
  'hudChrome.startZoneTerrainSurvey.selectedTemplate': '建筑模板',
  'hudChrome.startZoneTerrainSurvey.rotation': 'Y 轴旋转',
  'hudChrome.startZoneTerrainSurvey.showGrid': '显示网格',
  'hudChrome.startZoneTerrainSurvey.hideGrid': '隐藏网格',
  'hudChrome.startZoneTerrainSurvey.smallHouse': '小型房屋 6 x 6',
  'hudChrome.startZoneTerrainSurvey.mediumHouse': '中型房屋 10 x 8',
  'hudChrome.startZoneTerrainSurvey.largeHouse': '大型房屋 14 x 12',
  'hudChrome.startZoneTerrainSurvey.centralPlaza': '中央广场 20 x 20',
  'hudChrome.startZoneTerrainSurvey.road': '道路 4 x 12',
  'hudChrome.startZoneTerrainSurvey.minimumHeight': '最低高度：{value} 米',
  'hudChrome.startZoneTerrainSurvey.maximumHeight': '最高高度：{value} 米',
  'hudChrome.startZoneTerrainSurvey.averageSlope': '平均坡度：{value} 度',
  'hudChrome.startZoneTerrainSurvey.maximumSlope': '最大坡度：{value} 度',
  'hudChrome.startZoneTerrainSurvey.flatSurface': '平坦地形：{value}%',
  'hudChrome.startZoneTerrainSurvey.compatibleSurfaces': '适配区域：{count}',
  'hudChrome.startZoneTerrainSurvey.anchorsCount': '已保存锚点：{count}',
  'hudChrome.startZoneTerrainSurvey.verdict': '光标位置判定：{verdict}',
  'hudChrome.startZoneTerrainSurvey.compatible': '兼容',
  'hudChrome.startZoneTerrainSurvey.incompatible': '不兼容',
  'hudChrome.startZoneTerrainSurvey.noTerrain': '在勘测地形范围之外',
  'hudChrome.startZoneTerrainSurvey.cornerDifference': '{corner}：{value} 米',
  'hudChrome.startZoneTerrainSurvey.anchorName': '锚点名称',
  'hudChrome.startZoneTerrainSurvey.anchorNameDefault': '勘测锚点',
  'hudChrome.startZoneTerrainSurvey.proposedType': '建议类型',
  'hudChrome.startZoneTerrainSurvey.notes': '备注',
  'hudChrome.startZoneTerrainSurvey.saveAnchor': '保存锚点',
  'hudChrome.startZoneTerrainSurvey.clearAnchors': '清除锚点',
  'hudChrome.startZoneTerrainSurvey.exportReport': '导出 JSON 报告',
  'hudChrome.startZoneTerrainSurvey.typeBuildingSmall': '小型建筑',
  'hudChrome.startZoneTerrainSurvey.typeBuildingMedium': '中型建筑',
  'hudChrome.startZoneTerrainSurvey.typeBuildingLarge': '大型建筑',
  'hudChrome.startZoneTerrainSurvey.typePlaza': '广场',
  'hudChrome.startZoneTerrainSurvey.typeRoad': '道路',
  'hudChrome.startZoneTerrainSurvey.typeDecorative': '装饰',
  'hudChrome.startZoneTerrainSurvey.typeAvoid': '避开',
  'hudChrome.startZoneTerrainSurvey.statusAnchorSaved': '锚点已保存在本地',
  'hudChrome.startZoneTerrainSurvey.statusAnchorRejected': '无法保存锚点',
  'hudChrome.startZoneTerrainSurvey.statusAnchorsCleared': '本地锚点已清除',
  ...
  'seo.officialLabel': 'World of CodexCraft 官方网站',
  'seo.officialBody':
  ...
  'playerCard.defaultRealm': 'CodexCraft 世界',
  ...
  'playerCard.shareText':
    '我正在 World of CodexCraft 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：',
  'playerCard.nativeShareTitle': 'CodexCraft 世界',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'World of CodexCraft：经典风格网页 MMO',
  'seo.description':
    '在 World of CodexCraft 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 World of CodexCraft 的 GitHub 项目',
  'a11y.discordCommunity': '加入 World of CodexCraft 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 World of CodexCraft',
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 World of CodexCraft。',
  ...
  'mode.play': '开始游戏',
  'mode.playAria': '开始游玩 World of CodexCraft',
  ...
  'guide.worldPage.intro':
    'World of CodexCraft 是一片连绵不绝、需你徒步穿越的大陆，三大区域由南向北依次铺展。这里没有快速旅行，因此旅途本身便是冒险的一部分。',
  ...
  'hudChrome.nativeUpdate.body': 'World of CodexCraft 有新版本可用。立即更新以获取最新修复和改进。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'World of CodexCraft {version} 版本已可用。立即更新以获取最新修复和改进。',
  ...
  'desktop.crash.fatalBody': 'World of CodexCraft 遇到意外错误，需要关闭。',
  'editor.appTitle': '地图编辑器',
  'editor.docTitle': '地图编辑器 - World of CodexCraft',
