...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    "naturePlacementLab": {
      ...
      "confirmDeleteProject": "删除当前本地项目？",
      "untitledProjectName": "未命名项目",
      "importedProjectName": "导入的放置项目",
      "createLayer": "创建图层",
      "renameLayer": "重命名图层",
      "deleteLayer": "删除图层",
      "deleteLayerPlacements": "删除图层对象",
      "layerNamePrompt": "图层名称",
      ...
      "confirmDeleteLayer": "删除这个空图层？",
      "confirmDeleteLayerPlacements": "删除此图层中所有未锁定对象？",
      "visible": "可见",
      "locked": "已锁定",
      "selectLayer": "选择图层",
      "selectAll": "全选",
      ...
      "selectByAsset": "按资源选择",
      "moveToLayer": "移至图层",
      "selectedCount": "已选对象：{count}",
      "selectedAssets": "已选资源：{assets}",
      "selectedLayers": "已选图层：{layers}",
      "groupSelection": "组合所选对象",
      "ungroup": "取消组合",
      "renameGroup": "重命名组",
      "selectGroup": "选择组",
      "duplicateGroup": "复制组",
      "deleteGroup": "删除组",
      "deleteGroupAndPlacements": "删除组及对象",
      "groupNamePrompt": "组名称",
      "confirmDeleteGroupPlacements": "删除此组及其中所有未锁定对象？",
      "groupCopyName": "{name} 副本",
      "groupSummary": "{name}（{count}）",
      "applyGroupTransform": "应用组变换",
      "selectionCenterX": "选择中心 X",
      "selectionCenterY": "选择中心 Y",
      "selectionCenterZ": "选择中心 Z",
      "rotationDelta": "旋转增量（度）",
      "scaleFactor": "相对缩放系数",
      "groundOffsetDelta": "地面偏移增量",
      "totalPlacements": "对象总数：{count}",
      "visiblePlacements": "可见对象：{count}",
      "statisticsSelected": "已选对象：{count}",
      "placementsByAsset": "按资源：{counts}",
      "placementsByLayer": "按图层：{counts}",
      "estimatedTriangles": "预计三角形：{count}",
      "estimatedMediaBytes": "唯一资源媒体：{count} 字节",
      "assetsAria": "实验室资源",
      ...
      "available": "可用",
      "unavailable": "不可用",
      "historyState": "撤销：{undo}。重做：{redo}。",
      "selectedObject": "所选对象：{id}",
      "selectedAsset": "所选资源：{assetId}",
      "noAssetSelected": "未选择资源",
      "cancelPlacement": "取消放置",
      "placementsCount": "实验室放置数：{count}",
      "help": "Ctrl+Z/Y 撤销和重做。Ctrl+D 复制。G 切换网格。X 切换位置吸附。T 放置到地面。R 旋转。滚轮或加减键缩放。Page Up 和 Page Down 调整高度。",
      "statusReady": "就绪",
      ...
      "statusNothingToUndo": "没有可撤销的操作",
      "statusNothingToRedo": "没有可重做的操作",
      "statusUndone": "已撤销上次编辑",
      "statusRedone": "已恢复上次编辑",
      "statusDuplicateFailed": "无法复制所选放置对象",
      "statusDuplicated": "已复制并选择 {id}",
      "statusTransformRejected": "变换被拒绝",
      "statusTransformApplied": "变换已应用",
      "statusTransformReset": "变换已重置为资源默认值",
      "statusPlacedOnGround": "放置对象已对齐现有地形",
      "statusPreferencesSaved": "编辑器选项已更新",
      "statusFiniteRequired": "{field} 必须是有限数字",
      "statusOutsideLimits": "{field} 必须介于 {min} 和 {max} 之间",
      "statusLockedLayer": "锁定的图层阻止了此操作",
      "statusOperationRejected": "操作被拒绝",
      "statusProjectCreated": "项目已创建",
      "statusProjectRenamed": "项目已重命名",
      "statusProjectSaved": "项目已保存到本地",
      "statusProjectLoaded": "项目已加载",
      "statusProjectDeleted": "项目已删除",
      "statusProjectFailed": "项目操作失败",
      "statusLayerCreated": "图层已创建",
      "statusLayerRenamed": "图层已重命名",
      "statusLayerDeleted": "图层已删除",
      "statusLayerCleared": "图层对象已删除",
      "statusLayerUpdated": "图层状态已更新",
      "statusLayerChanged": "所选对象已移至图层",
      "statusGroupCreated": "组已创建",
      "statusGroupRenamed": "组已重命名",
    ...
    "startZoneTerrainSurvey": {
      "title": "起始区域地形勘测",
      "terrainSection": "地形分析",
      "footprintSection": "建筑占地",
      "anchorSection": "锚点",
      "resolution": "网格分辨率",
      "selectedTemplate": "建筑模板",
      "rotation": "Y 轴旋转",
      "showGrid": "显示网格",
      "hideGrid": "隐藏网格",
      ...
      "centralPlaza": "中央广场 20 x 20",
      "road": "道路 4 x 12",
      "minimumHeight": "最低高度：{value} 米",
      "maximumHeight": "最高高度：{value} 米",
      "averageSlope": "平均坡度：{value} 度",
      "maximumSlope": "最大坡度：{value} 度",
      "flatSurface": "平坦地形：{value}%",
      "compatibleSurfaces": "适配区域：{count}",
      "anchorsCount": "已保存锚点：{count}",
      "verdict": "光标位置判定：{verdict}",
      "compatible": "兼容",
      "incompatible": "不兼容",
      "noTerrain": "在勘测地形范围之外",
      "cornerDifference": "{corner}：{value} 米",
      "anchorName": "锚点名称",
      "anchorNameDefault": "勘测锚点",
      "proposedType": "建议类型",
      "notes": "备注",
      "saveAnchor": "保存锚点",
      "clearAnchors": "清除锚点",
      "exportReport": "导出 JSON 报告",
      "typeBuildingSmall": "小型建筑",
      "typeBuildingMedium": "中型建筑",
      "typeBuildingLarge": "大型建筑",
      "typePlaza": "广场",
      "typeRoad": "道路",
      "typeDecorative": "装饰",
      "typeAvoid": "避开",
      "statusAnchorSaved": "锚点已保存在本地",
      "statusAnchorRejected": "无法保存锚点",
      "statusAnchorsCleared": "本地锚点已清除"
    },
