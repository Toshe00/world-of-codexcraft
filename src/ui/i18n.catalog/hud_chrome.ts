...
export const hudChromeStrings = {
  naturePlacementLab: {
    ...
    publicationPreviewSection: 'Publication Preview',
    ...
    confirmDeleteProject: 'Delete the active local project?',
    untitledProjectName: 'Untitled Project',
    importedProjectName: 'Imported Placements',
    createLayer: 'Create Layer',
    renameLayer: 'Rename Layer',
    deleteLayer: 'Delete Layer',
    deleteLayerPlacements: 'Delete Layer Objects',
    layerNamePrompt: 'Layer name',
    defaultLayerTrees: 'Trees',
    defaultLayerBushes: 'Bushes',
    defaultLayerFlowers: 'Flowers',
    defaultLayerGrass: 'Grass',
    defaultLayerDeadNature: 'Dead Nature',
    defaultLayerOther: 'Other',
    confirmDeleteLayer: 'Delete this empty layer?',
    confirmDeleteLayerPlacements: 'Delete every unlocked object in this layer?',
    visible: 'Visible',
    locked: 'Locked',
    ...
    selectByAsset: 'Select by Asset',
    moveToLayer: 'Move to Layer',
    selectedCount: 'Selected objects: {count}',
    selectedAssets: 'Selected assets: {assets}',
    selectedLayers: 'Selected layers: {layers}',
    ...
    deleteGroupAndPlacements: 'Delete Group And Placements',
    groupNamePrompt: 'Group name',
    confirmDeleteGroupPlacements: 'Delete this group and every unlocked object in it?',
    groupCopyName: '{name} Copy',
    groupSummary: '{name} ({count})',
    applyGroupTransform: 'Apply Group Transform',
    selectionCenterX: 'Selection center X',
    selectionCenterY: 'Selection center Y',
    selectionCenterZ: 'Selection center Z',
    rotationDelta: 'Rotation delta (degrees)',
    scaleFactor: 'Relative scale factor',
    groundOffsetDelta: 'Ground offset delta',
    totalPlacements: 'Total placements: {count}',
    visiblePlacements: 'Visible placements: {count}',
    statisticsSelected: 'Selected placements: {count}',
    placementsByAsset: 'By asset: {counts}',
    placementsByLayer: 'By layer: {counts}',
    estimatedTriangles: 'Estimated triangles: {count}',
    estimatedMediaBytes: 'Unique asset media: {count} bytes',
    ...
    defaultZoneName: 'Laboratory Nature Zone',
    layersToPublish: 'Layers to publish',
    buildZonePackage: 'Build Zone Package',
    previewCompiledZone: 'Preview Compiled Zone',
    stopPreview: 'Stop Preview',
    exportZonePackage: 'Export Zone Package',
    publishedZonePreview: 'Published Zone Preview',
    noCompiledPackage: 'No compiled zone package',
    packageSummary: '{name} ({zoneId})',
    packageSource: 'Source project: {projectId}, version {version}',
    packageLayers: 'Included layers: {layers}',
    packagePlacementCount: 'Compiled placements: {count}',
    packageEstimatedTriangles: 'Compiled triangles: {count}',
    packageUniqueMediaBytes: 'Unique media: {count} bytes',
    packageBounds: 'Bounds: X {minX} to {maxX}, Y {minY} to {maxY}, Z {minZ} to {maxZ}',
    packageAssets: 'Compiled assets: {assets}',
    noPublicationWarnings: 'No publication warnings',
    warningHiddenLayersIncluded: '{count} selected hidden layers will be included',
    warningEmptyLayersIncluded: '{count} selected layers contain no placements',
    warningCompiledPackageStale: 'The project changed after this package was compiled',
    apply: 'Apply',
    ...
    rotationYDegrees: 'Rotation Y (degrees)',
    scale: 'Scale',
    groundOffsetY: 'Ground offset Y',
    showGrid: 'Show Grid',
    hideGrid: 'Hide Grid',
    ...
    historyState: 'Undo: {undo}. Redo: {redo}.',
    ...
    help: 'Ctrl+Z/Y undo and redo. Ctrl+D duplicates. G toggles the grid. X toggles position snap. T places on ground. R rotates. Wheel or plus and minus scales. Page Up and Page Down adjust height.',
    statusReady: 'Ready',
    ...
    statusZonePackageBuilt: 'Zone package built with {count} placements',
    statusZonePackageBuildFailed: 'Zone package build failed',
    statusBuildZonePackageFirst: 'Build a zone package first',
    statusZonePackageExported: 'Zone package exported with {count} placements',
    statusPreviewStopped: 'Compiled zone preview stopped',
    statusPreviewReadOnly: 'Published zone preview is read-only',
    statusPreviewUnavailable: 'Compiled zone preview is unavailable',
    statusStopPreviewFirst: 'Stop the compiled zone preview first',
    statusFinishEditFirst: 'Finish the active edit before building or previewing',
    statusTransformAdjusted: 'Transform adjusted',
    statusNothingToUndo: 'Nothing to undo',
    statusNothingToRedo: 'Nothing to redo',
    statusUndone: 'Last edit undone',
    statusRedone: 'Last edit restored',
    statusDuplicateFailed: 'The selected placement could not be duplicated',
    statusDuplicated: '{id} duplicated and selected',
    statusTransformRejected: 'The transform was rejected',
    statusTransformApplied: 'Transform applied',
    statusTransformReset: 'Transform reset to asset defaults',
    statusPlacedOnGround: 'Placement aligned to the existing terrain',
    statusPreferencesSaved: 'Editor options updated',
    statusFiniteRequired: '{field} must be a finite number',
    statusOutsideLimits: '{field} must be between {min} and {max}',
    statusLockedLayer: 'A locked layer prevents this operation',
    statusOperationRejected: 'The operation was rejected',
    statusProjectCreated: 'Project created',
    statusProjectRenamed: 'Project renamed',
    statusProjectSaved: 'Project saved locally',
    statusProjectLoaded: 'Project loaded',
    statusProjectDeleted: 'Project deleted',
    statusProjectFailed: 'The project operation failed',
    statusLayerCreated: 'Layer created',
    statusLayerRenamed: 'Layer renamed',
    statusLayerDeleted: 'Layer deleted',
    statusLayerCleared: 'Layer objects deleted',
    statusLayerUpdated: 'Layer state updated',
    statusLayerChanged: 'Selection moved to layer',
    statusGroupCreated: 'Group created',
    statusGroupRenamed: 'Group renamed',
    statusGroupDuplicated: 'Group duplicated',
    statusGroupDeleted: 'Group deleted',
  },
  startZoneTerrainSurvey: {
    title: 'Starter Zone Terrain Survey',
    terrainSection: 'Terrain Analysis',
    footprintSection: 'Building Footprint',
    anchorSection: 'Anchor Points',
    resolution: 'Grid resolution',
    selectedTemplate: 'Building template',
    rotation: 'Rotation Y',
    showGrid: 'Show Grid',
    hideGrid: 'Hide Grid',
    smallHouse: 'Small house 6 x 6',
    mediumHouse: 'Medium house 10 x 8',
    largeHouse: 'Large house 14 x 12',
    centralPlaza: 'Central plaza 20 x 20',
    road: 'Road 4 x 12',
    minimumHeight: 'Minimum height: {value} m',
    maximumHeight: 'Maximum height: {value} m',
    averageSlope: 'Average slope: {value} degrees',
    maximumSlope: 'Maximum slope: {value} degrees',
    flatSurface: 'Flat terrain: {value}%',
    compatibleSurfaces: 'Compatible surfaces: {count}',
    anchorsCount: 'Saved anchors: {count}',
    verdict: 'Cursor verdict: {verdict}',
    compatible: 'compatible',
    incompatible: 'incompatible',
    noTerrain: 'outside the surveyed terrain',
    cornerDifference: '{corner}: {value} m',
    anchorName: 'Anchor name',
    anchorNameDefault: 'Survey anchor',
    proposedType: 'Proposed type',
    notes: 'Notes',
    saveAnchor: 'Save Anchor Point',
    clearAnchors: 'Clear Anchor Points',
    exportReport: 'Export JSON Report',
    typeBuildingSmall: 'Small building',
    typeBuildingMedium: 'Medium building',
    typeBuildingLarge: 'Large building',
    typePlaza: 'Plaza',
    typeRoad: 'Road',
    typeDecorative: 'Decorative',
    typeAvoid: 'Avoid',
    statusAnchorSaved: 'Anchor point saved locally',
    statusAnchorRejected: 'Anchor point could not be saved',
    statusAnchorsCleared: 'Local anchor points cleared',
  },
  startZoneTerrainPlateau: {
    title: 'Starter Zone Plateau Lab',
    enabled: 'Show plateau',
    centerX: 'Center X',
    centerZ: 'Center Z',
    width: 'Width',
    depth: 'Depth',
    ...
    blendWidth: 'Transition width',
    falloff: 'Transition curve',
    linear: 'Linear',
    smoothstep: 'Smoothstep',
    smootherstep: 'Smootherstep',
    averageHeight: 'Use average height',
    cursorHeight: 'Use cursor height',
    undo: 'Undo',
    redo: 'Redo',
    reset: 'Reset',
    export: 'Export JSON',
    import: 'Import JSON',
    importPlaceholder: 'Paste a plateau patch JSON document',
    target: 'Target height: {value} m',
    minimum: 'Original minimum: {value} m',
    maximum: 'Original maximum: {value} m',
    raised: 'Maximum raised terrain: {value} m',
    lowered: 'Maximum lowered terrain: {value} m',
    flatArea: 'Perfectly flat area: {value} m²',
    transitionArea: 'Transition area: {value} m²',
    protectedWarning: 'Protected zones intersect the plateau: {count}',
    showProtectedZones: 'Show protected zones',
    protectedZonesHelp: 'These circles mark protected areas around NPCs, merchants, quest points, and other important elements.',
  },
  publishedZoneLab: {
  ...
  nativeUpdate: {
    ...
    body: 'A new version of World of CodexCraft is available. Update now for the latest fixes and improvements.',
    bodyWithVersion:
      'Version {version} of World of CodexCraft is available. Update now for the latest fixes and improvements.',
    notNow: 'Not now',
    update: 'Update',
  },
