...
export const en: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "bodyWithVersion": "Version {version} of World of CodexCraft is available. Update now for the latest fixes and improvements.",
      "notNow": "Not now",
      "update": "Update"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "The world",
      "intro": "World of CodexCraft is one continuous land you cross on foot, three zones laid south to north. There is no fast travel, so the journey is part of the adventure.",
      "hub": "Home base",
  ...
  "playerCard": {
    ...
    "shareText": "I'm forging my legend in World of CodexCraft: Level {level} {className}{tierBit}. Join my world:",
  ...
  "seo": {
    "title": "World of CodexCraft: Classic-Style Web MMO",
    "description": "Embark on an epic adventure in World of CodexCraft, a classic-style micro-MMO playable directly in your browser. Join a persistent shared world, level up classes, and defeat enemies!",
    "genre": "MMORPG",
    "playMode": "Multiplayer",
    "applicationCategory": "Game",
    "operatingSystem": "Web browser",
    "officialLabel": "Official World of CodexCraft website",
  ...
  "a11y": {
    ...
    "githubProject": "Open the World of CodexCraft GitHub project",
    "discordCommunity": "Join the World of CodexCraft Discord community",
    "donateProject": "Donate to support World of CodexCraft"
  },
  "loading": {
    "world": "Loading world...",
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Open World of CodexCraft from the new Home Screen icon.",
    ...
    "androidOpenStep": "Open World of CodexCraft from the new icon.",
  ...
  "serverUnavailable": {
    "title": "World of CodexCraft - World Unavailable",
