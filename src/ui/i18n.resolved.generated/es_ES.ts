...
export const es_ES: EnTranslations = {
  ...
  "seo": {
    ...
    "description": "Emprende una aventura épica en World of CodexCraft, un micro-MMO de estilo clásico jugable directamente en tu navegador. Únete a un mundo compartido persistente, sube de nivel tus clases y derrota a tus enemigos.",
    "genre": "MMORPG",
  ...
  "a11y": {
    ...
    "githubProject": "Abrir el proyecto World of CodexCraft en GitHub",
